...
public class CatalogEntryServiceImpl extends SalesManagerEntityServiceImpl<Long, CatalogEntry>
  ...
  @Autowired private PageableCatalogEntryRepository pageableCatalogEntryRepository;
  ...
  @Override
  public Page<CatalogEntry> list(
      Catalog catalog, MerchantStore store, Language language, String name, int page, int count)
