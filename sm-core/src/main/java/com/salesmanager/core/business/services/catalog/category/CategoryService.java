...
public interface CategoryService extends SalesManagerEntityService<Long, Category> {
  ...
  Category getByCode(String name) throws ServiceException;
  ...
  Category saveOrUpdate(Category category) throws ServiceException;

  Category createOrUpdate(Category category) throws ServiceException;
  ...
  List<Category> getCategoryIds() throws ServiceException;

  List<Category> getCategorysByCriteria(final Criteria criteria) throws ServiceException;
}
