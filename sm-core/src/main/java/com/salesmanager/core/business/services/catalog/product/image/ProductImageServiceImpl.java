...
import com.salesmanager.core.business.modules.cms.products.product.ProductFileManager;
...
public class ProductImageServiceImpl extends SalesManagerEntityServiceImpl<Long, ProductImage>
  ...
  @Inject private ProductFileManager productFileManager;
  ...
  public void addProductImageDescription(
      ProductImage productImage, ProductImageDescription description) throws ServiceException {
  ...
  @Override
  public Set<ProductImage> getProductImagesByProductSkuId(String skuId) throws ServiceException {
    return productService.getBySkuId(skuId).getImages();
  }

  @Override
  public Set<ProductImage> getProductImagesByProductId(Long id) throws ServiceException {
    return productService.getByProductId(id).getImages();
  }
