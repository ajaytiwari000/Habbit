...
public final class EncryptionImpl implements Encryption {
  ...
  private static final String IV_P = "fedcba9876543210";
  private static final String KEY_SPEC = "AES";
  private static final String CYPHER_SPEC = "AES/CBC/PKCS5Padding";
  ...
  public String decrypt(String value) throws Exception {
    ...
    if (StringUtils.isBlank(value)) throw new Exception("Nothing to encrypt");
