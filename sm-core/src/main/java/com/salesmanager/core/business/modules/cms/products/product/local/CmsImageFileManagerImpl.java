package com.salesmanager.core.business.modules.cms.products.product.local;
...
public class CmsImageFileManagerImpl implements ProductAssetsManager {
  ...
  public void removeProductImages(Product product) throws ServiceException {
    ...
    try {
      ...
      nodePath
          .append(buildRootPath())
          .append(Constants.SLASH)
          .append(product.getMerchantStore().getCode())
          .append(Constants.SLASH)
  ...
  public OutputContentFile getProductImage(
    ...
    return getProductImage(
        merchantStoreCode, productCode, imageName, ProductImageSize.SMALL.name());
  }
