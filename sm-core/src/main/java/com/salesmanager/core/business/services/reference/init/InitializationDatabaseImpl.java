...
public class InitializationDatabaseImpl implements InitializationDatabase {
  ...
  @Inject private ZonesLoader zonesLoader;

  @Inject private IntegrationModulesLoader modulesLoader;
  ...
  private void createModules() throws ServiceException {
    ...
    try {
      ...
      List<IntegrationModule> modules =
          modulesLoader.loadIntegrationModules("reference/integrationmodules.json");
