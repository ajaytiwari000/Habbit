...
public class ProductAttributeServiceImpl
  ...
  @Override
  public List<ProductAttribute> getByProductId(
      MerchantStore store, Product product, Language language) throws ServiceException {
    return productAttributeRepository.findByProductId(
        store.getId(), product.getId(), language.getId());
  }
  ...
  public List<ProductAttribute> getProductAttributesByCategoryLineage(
    ...
    List<ProductAttribute> attributes =
        productAttributeRepository.findOptionsByCategoryLineage(
