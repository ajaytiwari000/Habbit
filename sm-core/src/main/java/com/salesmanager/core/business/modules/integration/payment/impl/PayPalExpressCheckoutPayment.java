...
public class PayPalExpressCheckoutPayment implements PaymentModule {
  ...
  public Transaction authorize(
    ...
    com.salesmanager.core.model.payments.PaypalPayment paypalPayment =
  ...
  public Transaction initPaypalTransaction(
      MerchantStore store,
      List<ShoppingCartItem> items,
    ...
    try {
      ...
      if (configuration
        ...
        paymentDetails.setPaymentAction(
            urn.ebay.apis.eBLBaseComponents.PaymentActionCodeType.AUTHORIZATION);
      }
      ...
      StringBuilder RETURN_URL =
          new StringBuilder()
              .append(coreConfiguration.getProperty("SHOP_SCHEME", "http"))
              .append("://")
      ...
      String returnUrl =
          RETURN_URL.toString()
              + new StringBuilder()
                  ...
                  .append(coreConfiguration.getProperty("URL_EXTENSION", ".html"))
                  .append("/success")
                  .toString();
      String cancelUrl =
          RETURN_URL.toString()
      ...
      SetExpressCheckoutResponseType setExpressCheckoutResponse =
          service.setExpressCheckout(setExpressCheckoutReq);
  ...
  public Transaction refund(
    ...
    try {
      ...
      Validate.notNull(
          (String) transaction.getTransactionDetails().get("TRANSACTIONID"),
      ...
      refundTransactionRequest.setTransactionID(
          transaction.getTransactionDetails().get("TRANSACTIONID"));

      RefundTransactionResponseType refundTransactionResponse =
          service.refundTransaction(refundRequest);
      ...
      if (!"Success".equals(refundAck)) {
        ...
        throw new IntegrationException(
            ServiceException.EXCEPTION_TRANSACTION_DECLINED,
            "Paypal refund transaction code ["
                + refundTransactionResponse.getErrors().get(0).getErrorCode()
                + "], message-> "
                + refundTransactionResponse.getErrors().get(0).getShortMessage());
      }
  ...
  private Transaction processTransaction(
    ...
    try {
      ...
      GetExpressCheckoutDetailsRequestType getExpressCheckoutDetailsRequest =
          new GetExpressCheckoutDetailsRequestType(paypalPayment.getPaymentToken());
      ...
      getExpressCheckoutDetailsReq.setGetExpressCheckoutDetailsRequest(
      ...
      GetExpressCheckoutDetailsResponseType getExpressCheckoutDetailsResponse =
          service.getExpressCheckoutDetails(getExpressCheckoutDetailsReq);
      ...
      if (payment.getTransactionType().name().equals(TransactionType.AUTHORIZE.name())) {
        paymentDetail.setPaymentAction(
            urn.ebay.apis.eBLBaseComponents.PaymentActionCodeType.AUTHORIZATION);
      } else {
  ...
  public Transaction capture(
    ...
    try {
      ...
      DoCaptureRequestType doCaptureRequest =
      ...
      if (!"Success".equals(doCaptureResponse.getAck().getValue())) {
        LOGGER.error(
            "Wrong value from transaction commit " + doCaptureResponse.getAck().getValue());
        throw new IntegrationException(
