...
public class CategoryServiceImpl extends SalesManagerEntityServiceImpl<Long, Category>
  ...
  @Inject private CategoryDescriptionRepository categoryDescriptionRepository;
  ...
  @Override
  public Category saveOrUpdate(Category category) throws ServiceException {
  ...
  @Override
  public Category createOrUpdate(Category category) throws ServiceException {
    if (category.getId() != null && category.getId() > 0) {
  ...
  public Category getById(Long id) {
    return categoryRepository.findByCategoryId(id).orElse(null);
  }
  ...
  public void delete(Category category) throws ServiceException {
    ...
    if (dbCategory != null && dbCategory.getId().longValue() == category.getId().longValue()) {
      ...
      try {
        ...
        List<CategoryBanner> categoryBanners = category.getCategoryDetails().getCategoryBanners();

        for (CategoryBanner categoryBanner : categoryBanners) {
          categoryBannerService.removeCategoryBanner(categoryBanner, category.getId());
        }
  ...
  public void addChild(Category parent, Category child) throws ServiceException {
    ...
    try {
      ...
      if (parent == null) {
        ...
        child.setLineage(
            new StringBuilder().append("/").append(child.getId()).append("/").toString());
  ...
  @Override
  public List<Category> getCategoryIds() throws ServiceException {
    try {
      return categoryRepository.getCategoryIds().orElse(null);
    } catch (Exception e) {
      throw new ServiceException(e);
    }
  }
  ...
  @Override
  public List<Category> getCategorysByCriteria(final Criteria criteria) throws ServiceException {
    try {
      return categoryRepository.getCategorysByCriteria(criteria);
    } catch (Exception e) {
      throw new ServiceException(e);
    }
  }
