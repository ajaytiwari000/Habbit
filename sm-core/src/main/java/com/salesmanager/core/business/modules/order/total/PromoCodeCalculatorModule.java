...
public class PromoCodeCalculatorModule implements OrderTotalPostProcessorModule {
  ...
  @Autowired private DroolsBeanFactory droolsBeanFactory;
  ...
  @Override
  public OrderTotal caculateProductPiceVariation(
    ...
    KieSession kieSession =
        droolsBeanFactory.getKieSession(
            ResourceFactory.newClassPathResource("com/salesmanager/drools/rules/PromoCoupon.drl"));
