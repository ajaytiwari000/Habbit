...
public class UPSShippingQuote implements ShippingQuoteModule {
  ...
  public List<ShippingOption> getShippingQuotes(
    ...
    Validate.notNull(
        configuration, "IntegrationConfiguration must not be null for USPS shipping module");
    ...
    try {
      ...
      String xml =
          "<?xml version=\"1.0\"?><RatingServiceSelectionRequest><Request><TransactionReference><CustomerContext>Shopizer</CustomerContext><XpciVersion>1.0001</XpciVersion></TransactionReference><RequestAction>Rate</RequestAction><RequestOption>Shop</RequestOption></Request>";
      StringBuffer xmldatabuffer = new StringBuffer();

      /**
       * <Shipment>
       *
       * <p><Shipper> <Address> <City></City> <StateProvinceCode>QC</StateProvinceCode>
       * <CountryCode>CA</CountryCode> <PostalCode></PostalCode> </Address> </Shipper>
       *
       * <p><ShipTo> <Address> <City>Redwood Shores</City> <StateProvinceCode>CA</StateProvinceCode>
       * <CountryCode>US</CountryCode> <PostalCode></PostalCode> <ResidentialAddressIndicator/>
       * </Address> </ShipTo>
       *
       * <p><Package> <PackagingType> <Code>21</Code> </PackagingType> <PackageWeight>
       * <UnitOfMeasurement> <Code>LBS</Code> </UnitOfMeasurement> <Weight>1.1</Weight>
       * </PackageWeight> <PackageServiceOptions> <InsuredValue> <CurrencyCode>CAD</CurrencyCode>
       * <MonetaryValue>100</MonetaryValue> </InsuredValue> </PackageServiceOptions> </Package>
       *
       * <p></Shipment>
       *
       * <p><CustomerClassification> <Code>03</Code> </CustomerClassification>
       ...
       *
       * <p>Country storeCountry = (Country) countriesMap.get(store .getCountry());
       *
       * <p>Country customerCountry = (Country) countriesMap.get(customer .getCustomerCountryId());
       *
       * <p>int sZone = -1; try { sZone = Integer.parseInt(store.getZone()); } catch (Exception e) {
       * // TODO: handle exception }
       *
       * <p>Zone storeZone = (Zone) zonesMap.get(sZone); Zone customerZone = (Zone)
      ...
      for (PackageDetails packageDetail : packages) {
        ...
        xmldatabuffer.append(
            new BigDecimal(packageDetail.getShippingWeight())
        ...
        xmldatabuffer.append(
            new BigDecimal(packageDetail.getShippingLength())
        ...
        xmldatabuffer.append(
            new BigDecimal(packageDetail.getShippingHeight())
                .setScale(2, BigDecimal.ROUND_HALF_UP));
        xmldatabuffer.append("</Height>");
        xmldatabuffer.append("</Dimensions>");
        xmldatabuffer.append("</Package>");
      ...
      try (CloseableHttpClient httpclient = HttpClients.createDefault()) {
        ...
        StringEntity entity =
            new StringEntity(xmlbuffer.toString(), ContentType.APPLICATION_ATOM_XML);
        ...
        digester.addCallMethod(
            "RatingServiceSelectionResponse/Response/ErrorDescriprion", "setError", 0);
        digester.addCallMethod(
            "RatingServiceSelectionResponse/Response/ResponseStatusCode", "setStatusCode", 0);
        digester.addCallMethod(
            "RatingServiceSelectionResponse/Response/ResponseStatusDescription",
            "setStatusMessage",
            0);
        digester.addCallMethod(
            "RatingServiceSelectionResponse/Response/Error/ErrorDescription", "setError", 0);

        digester.addObjectCreate(
            "RatingServiceSelectionResponse/RatedShipment", ShippingOption.class);
        // digester.addSetProperties(
        // "RatingServiceSelectionResponse/RatedShipment", "sequence",
        // "optionId" );
        digester.addCallMethod(
            "RatingServiceSelectionResponse/RatedShipment/Service/Code", "setOptionId", 0);
        digester.addCallMethod(
        ...
        //				"setCurrency", 0);
        digester.addCallMethod(
            "RatingServiceSelectionResponse/RatedShipment/Service/Code", "setOptionCode", 0);
        digester.addCallMethod(
            "RatingServiceSelectionResponse/RatedShipment/GuaranteedDaysToDelivery",
            "setEstimatedNumberOfDays",
            0);
