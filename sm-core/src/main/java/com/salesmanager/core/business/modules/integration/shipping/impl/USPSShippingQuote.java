...
public class USPSShippingQuote implements ShippingQuoteModule {
  ...
  public List<ShippingOption> getShippingQuotes(
    ...
    try {
      ...
      /**
       * Domestic <Package ID="1ST"> <Service>ALL</Service> <ZipOrigination>90210</ZipOrigination>
       * <ZipDestination>96698</ZipDestination> <Pounds>8</Pounds> <Ounces>32</Ounces> <Container/>
       * <Size>REGULAR</Size> <Machinable>true</Machinable> </Package>
       *
       * <p>//MAXWEIGHT=70 lbs
       *
       * <p>//domestic container default=VARIABLE whiteSpace=collapse enumeration=VARIABLE
       * enumeration=FLAT RATE BOX enumeration=FLAT RATE ENVELOPE enumeration=LG FLAT RATE BOX
       * enumeration=RECTANGULAR enumeration=NONRECTANGULAR
       *
       * <p>//INTL enumeration=Package enumeration=Postcards or aerogrammes enumeration=Matter for
       * the blind enumeration=Envelope
       *
       * <p>Size May be left blank in situations that do not Size. Defined as follows: REGULAR:
       * package plus girth is 84 inches or less; LARGE: package length plus girth measure more than
       * 84 inches not more than 108 inches; OVERSIZE: package length plus girth is more than 108
       * but not 130 inches. For example: <Size>REGULAR</Size>
       *
       * <p>International <Package ID="1ST"> <Machinable>true</Machinable>
       * <MailType>Envelope</MailType> <Country>Canada</Country> <Length>0</Length> <Width>0</Width>
       * <Height>0</Height> <ValueOfContents>250</ValueOfContents> </Package>
       *
       * <p><Package ID="2ND"> <Pounds>4</Pounds> <Ounces>3</Ounces> <MailType>Package</MailType>
       * <GXG> <Length>46</Length> <Width>14</Width> <Height>15</Height> <POBoxFlag>N</POBoxFlag>
       * <GiftFlag>N</GiftFlag> </GXG> <ValueOfContents>250</ValueOfContents>
       * <Country>Japan</Country> </Package>
       */
      ...
      if (store.getCountry().getIsoCode().equals(delivery.getCountry().getIsoCode())) {
        ...
        xmldatabuffer.append(
            "<Machinable>true</Machinable>"); // TODO must be changed if not machinable
      ...
      StringBuilder xmlbuffer =
          new StringBuilder()
              .append(xmlheader.toString())
              .append(xmldatabuffer.toString())
              .append(xmlfooter.toString());
      ...
      try (CloseableHttpClient httpclient = HttpClients.createDefault()) {
        ...
        /**
         * <RateV3Response> <Package ID="1ST"> <ZipOrigination>44106</ZipOrigination>
        ...
        if (store.getCountry().getIsoCode().equals(delivery.getCountry().getIsoCode())) {
          ...
          digester.addCallMethod(
              "IntlRateResponse/Package/Service/SvcDescription", "setOptionName", 0);
          digester.addCallMethod(
              "IntlRateResponse/Package/Service/SvcDescription", "setOptionCode", 0);
          digester.addCallMethod(
              "IntlRateResponse/Package/Service/Postage", "setOptionPriceText", 0);
          // digester.addCallMethod(
