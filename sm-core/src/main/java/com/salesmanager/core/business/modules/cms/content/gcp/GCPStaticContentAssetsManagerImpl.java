...
/**
 * Content management for a given retailer using GC{ (Google Cloud Platform) Cloud Storage with
 * buckets
 *
 * <p>Linux/ Mac export GOOGLE_APPLICATION_CREDENTIALS="/path/to/file" For Windows set
 * GOOGLE_APPLICATION_CREDENTIALS="C:\path\to\file"
 *
 * <p>following this article: https://www.baeldung.com/java-google-cloud-storage
 *
 * <p>gsutil ls -L -b gs://shopizer-content
 *
 * @author carlsamson
 */
...
public class GCPStaticContentAssetsManagerImpl implements ContentAssetsManager {
  ...
  public OutputContentFile getFile(
      String merchantStoreCode, FileContentType fileContentType, String contentName)
  ...
  public void removeFile(
      String merchantStoreCode, FileContentType staticContentType, String fileName)
      throws ServiceException {
    // TODO Auto-generated method stub
