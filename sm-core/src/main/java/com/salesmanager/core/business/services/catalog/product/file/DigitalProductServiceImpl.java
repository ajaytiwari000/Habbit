...
public class DigitalProductServiceImpl extends SalesManagerEntityServiceImpl<Long, DigitalProduct>
  ...
  @Inject StaticContentFileManager productDownloadsFileManager;
  ...
  public void addProductFile(
      Product product, DigitalProduct digitalProduct, InputContentFile inputFile)
  ...
  public void delete(DigitalProduct digitalProduct) throws ServiceException {
    ...
    productDownloadsFileManager.removeFile(
        digitalProduct.getProduct().getMerchantStore().getCode(),
