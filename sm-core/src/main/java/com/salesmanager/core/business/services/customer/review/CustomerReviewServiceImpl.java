...
public class CustomerReviewServiceImpl extends SalesManagerEntityServiceImpl<Long, CustomerReview>
  ...
  private CustomerReview saveOrUpdate(CustomerReview review) throws ServiceException {
  ...
  public CustomerReview update(CustomerReview review) throws ServiceException {
    return this.saveOrUpdate(review);
  }

  public CustomerReview create(CustomerReview review) throws ServiceException {
    return this.saveOrUpdate(review);
  }
