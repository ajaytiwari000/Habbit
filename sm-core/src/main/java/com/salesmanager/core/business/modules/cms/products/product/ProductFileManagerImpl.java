...
public class ProductFileManagerImpl extends ProductFileManager {
  ...
  private static final String PRODUCT_IMAGE_HEIGHT_SIZE = "PRODUCT_IMAGE_HEIGHT_SIZE";
  private static final String PRODUCT_IMAGE_WIDTH_SIZE = "PRODUCT_IMAGE_WIDTH_SIZE";
  private static final String CROP_UPLOADED_IMAGES = "CROP_UPLOADED_IMAGES";
  ...
  public void addProductImage(ProductImage productImage, ImageContentFile contentImage)
    ...
    try {
      ...
      String slargeImageHeight = null; // configuration.getProperty(PRODUCT_IMAGE_HEIGHT_SIZE);
      String slargeImageWidth = null; // configuration.getProperty(PRODUCT_IMAGE_WIDTH_SIZE);
