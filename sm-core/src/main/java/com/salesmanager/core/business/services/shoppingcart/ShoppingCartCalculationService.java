...
/**
 * Interface declaring various methods used to calculate {@link ShoppingCart} object details.
 *
...
public interface ShoppingCartCalculationService {
  /**
   * Method which will be used to calculate price for each line items as well Total and Sub-total
   * for {@link ShoppingCart}.
   *
