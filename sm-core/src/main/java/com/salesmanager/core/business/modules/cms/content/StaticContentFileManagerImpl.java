...
public class StaticContentFileManagerImpl extends StaticContentFileManager {
   ...
   * underlying CMSStaticContentManager. For CMS Content files {@link
   * CmsStaticContentFileManagerImpl} will take care of adding given content images with Infinispan
   * cache.
   *
