package com.salesmanager.core.business.modules.cms.products.product.gcp;
...
public class GCPProductContentFileManager implements ProductAssetsManager {
  ...
  @Autowired private CMSManager gcpAssetsManager;
  ...
  public OutputContentFile getProductImage(
    ...
    try {
      ...
      Blob blob =
          storage.get(
              BlobId.of(
                  bucketName, filePath(merchantStoreCode, productCode, size.name(), imageName)));
    ...
    try {
      ...
      Page<Blob> blobs =
          storage.list(
              ...
              BlobListOption.prefix(merchantStoreCode));
        ...
        new StringBuilder()
            .append(
                filePath(
                    ...
                    contentImage.getFileContentType()))
  ...
  private String filePath(String merchant, String sku, FileContentType contentImage) {
    ...
    sb.append(merchant).append(Constants.SLASH).append(sku).append(Constants.SLASH);
