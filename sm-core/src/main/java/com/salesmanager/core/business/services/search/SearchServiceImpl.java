...
public class SearchServiceImpl
    implements com.salesmanager.core.business.services.search.SearchService {

  private static final Logger LOGGER = LoggerFactory.getLogger(SearchServiceImpl.class);

  private static final String PRODUCT_INDEX_NAME = "product";
  private static final String UNDERSCORE = "_";
  private static final String INDEX_PRODUCTS = "INDEX_PRODUCTS";

  @Inject private com.shopizer.search.services.SearchService searchService;
  ...
  public void index(MerchantStore store, Product product) throws ServiceException {
     ...
     *
     * <p>A product entity will have to be transformed to a bean ProductIndex which contains the
     * indices as described in product.json
     *
     * <p>{"product": { "properties" : { "name" : {"type":"string","index":"analyzed"}, "price" :
     * {"type":"string","index":"not_analyzed"}, "category" :
     * {"type":"string","index":"not_analyzed"}, "lang" : {"type":"string","index":"not_analyzed"},
     * "available" : {"type":"string","index":"not_analyzed"}, "description" :
     * {"type":"string","index":"analyzed","index_analyzer":"english"}, "tags" :
     * {"type":"string","index":"not_analyzed"} } } }
     *
     * <p>productService saveOrUpdate as well as create and update will invoke
     * productSearchService.index
     *
     * <p>A copy of properies between Product to IndexProduct Then IndexProduct will be transformed
     * to a json representation by the invocation of .toJSONString on IndexProduct
     *
     * <p>Then index product searchService.index(json, "product_<LANGUAGE_CODE>_<MERCHANT_CODE>",
     * "product");
     *
     * <p>example ...index(json,"product_en_default",product)
     */
    ...
    for (ProductDescription description : descriptions) {
      ...
      collectionName
          .append(PRODUCT_INDEX_NAME)
          .append(UNDERSCORE)
          .append(description.getLanguage().getCode())
          .append(UNDERSCORE)
  ...
  public SearchKeywords searchForKeywords(String collectionName, String word, int entriesCount)
  ...
  public com.salesmanager.core.model.search.SearchResponse search(
      MerchantStore store, String languageCode, String term, int entriesCount, int startIndex)
      throws ServiceException {
    ...
    try {
      ...
      com.salesmanager.core.model.search.SearchResponse resp =
          new com.salesmanager.core.model.search.SearchResponse();
