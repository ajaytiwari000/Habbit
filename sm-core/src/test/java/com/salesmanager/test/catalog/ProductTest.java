...
public class ProductTest extends com.salesmanager.test.common.AbstractSalesManagerCoreTestCase {
  ...
  public void testCreateProduct() throws Exception {
    ...
    /** Creates a review TODO requires customer */
    // testReview(product);
    ...
    ProductAvailability updatableAvailability =
        updatableProduct.getAvailabilities().iterator().next();
  ...
  private void testAttributes(Product product) throws Exception {
    ...
    List<ProductAttribute> attributes =
        productAttributeService.getProductAttributesByCategoryLineage(
            store, product.getCategories().iterator().next().getLineage(), en);
  ...
  private void testViewImage(Product product) throws Exception {
    ...
    OutputContentFile contentFile =
        productImageService.getProductImage(
  ...
  private void testCreateRelationShip(Product product) throws Exception {
    ...
    // because relationships are nor joined fetched, make sure you query relationships first, then
    // ad to an existing list
