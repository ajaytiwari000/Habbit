...
public class CustomerTest extends com.salesmanager.test.common.AbstractSalesManagerCoreTestCase {
  ...
  public void createCustomer() throws ServiceException {
    ...
    Set<CustomerOptionDescription> mailingListDesciptionList =
        new HashSet<CustomerOptionDescription>();
    ...
    // --
    // now create an option set (association of a customer option with possible customer option
    // values)
    // --
    ...
    /**
     * Now create a customer option attribute A customer attribute is a selected customer option set
     * transformed to an attribute for a given customer
     */
