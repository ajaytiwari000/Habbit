...
public class ShippingDistanceProcessorTest {
  ...
  @Inject ShippingQuotePrePostProcessModule shippingDecisionTablePreProcessor;
  ...
  public void testDistance() throws Exception {
    ...
    // shippingDecisionTablePreProcessor.prePostProcessShippingQuotes(shippingQuote, null, null,
    // delivery, origin, null, null, null, null, null, Locale.CANADA);
