...
@Ignore
public class ShippingMethodDecisionTest
    extends com.salesmanager.test.common.AbstractSalesManagerCoreTestCase {

  @Inject ShippingDecisionPreProcessorImpl shippingMethodDecisionProcess;
  ...
  public void validateShippingMethod() throws Exception {
    ...
    shippingMethodDecisionProcess.prePostProcessShippingQuotes(
        quote,
        details,
        null,
        delivery,
    ...
    System.out.println(
        "Done : " + quote.getCurrentShippingModule() != null
            ? quote.getCurrentShippingModule().getCode()
            : currentModule.getCode());
  }
}
