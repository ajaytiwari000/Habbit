...
@Ignore
public class ShippingQuoteByWeightTest
  ...
  public void testGetCustomShippingQuotesByWeight() throws ServiceException {
    ...
    shippingConfiguration.setShippingBasisType(
        ShippingBasisType.SHIPPING); // based on shipping or billing address
    ...
    shippingService.saveShippingQuoteModuleConfiguration(
        configuration, store); // create the basic configuration
    shippingService.saveCustomShippingConfiguration(
        "weightBased", customConfiguration, store); // and the custom configuration
    ...
    ShippingQuote shippingQuote =
        shippingService.getShippingQuote(dummyCartId, store, delivery, shippingProducts, en);
