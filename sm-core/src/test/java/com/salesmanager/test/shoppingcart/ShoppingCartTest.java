 ...
 * Test
 *
 * <p>- Add a product to persistent shopping cart - Retrieve an item from the persistent shopping
 * cart - Rebuild a shopping cart item after the product definition has been modified
 *
 * @author Carl Samson
 */
