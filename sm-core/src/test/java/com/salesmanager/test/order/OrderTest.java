...
public class OrderTest extends com.salesmanager.test.common.AbstractSalesManagerCoreTestCase {
  ...
  public void getMerchantOrders() throws ServiceException {
    ...
    customer.setUserName("My New nick");
    ...
    creditsCard.setCardType(CreditCardType.VISA);

    creditsCard.setCcCvv("123");
    creditsCard.setCcExpires("12/30/2020");
    creditsCard.setCcNumber("123456789");
    creditsCard.setCcOwner("ccOwner");
    ...
    Assert.assertTrue(
        "Merchant Orders count is not one.",
