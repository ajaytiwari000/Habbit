...
public class Product extends SalesManagerEntity<Long, Product> implements Auditable {
  ...
  */
  ...
  @Column(name = "PRODUCT_FLAVOUR_TYPE_ID", nullable = true)
  private Long productFlavourTypeId;

  @Column(name = "PRODUCT_FEATURE_TYPE_ID", nullable = true)
  private Long productFeatureTypeId;
  ...
  @OneToMany(
      ...
      mappedBy =
          "product") // cascade is set to remove because product save requires logic to create
  // physical image first and then save the image id in the database, cannot be
  // done in cascade
  ...
  @Column(name = "PRODUCT_PREMIUM_CARD")
  private boolean productPremiumCard = false;

  @Column(name = "PRODUCT_BOOST")
  private boolean boostAvailable = false;

  @Column(name = "QTY_UNLIMITED")
  ...
  @JoinColumn(name = "PRODUCT_STICKER_IMAGE_ID", nullable = true, updatable = true)
  private ProductStickerImage productStickerImage;

  @OneToOne(fetch = FetchType.EAGER, cascade = CascadeType.ALL)
  @JoinColumn(name = "PRODUCT_NUTRITIONAL_INFO_ID", nullable = true, updatable = true)
  ...
  public Long getProductFlavourTypeId() {
    return productFlavourTypeId;
  }

  public void setProductFlavourTypeId(Long productFlavourTypeId) {
    this.productFlavourTypeId = productFlavourTypeId;
  }

  public Long getProductFeatureTypeId() {
    return productFeatureTypeId;
  }

  public void setProductFeatureTypeId(Long productFeatureTypeId) {
  ...
  public ProductStickerImage getProductStickerImage() {
    return productStickerImage;
  }

  public void setProductStickerImage(ProductStickerImage productStickerImage) {
