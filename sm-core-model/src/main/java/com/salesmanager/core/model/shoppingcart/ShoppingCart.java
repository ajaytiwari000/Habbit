...
/**
 * Shopping cart is responsible for storing and carrying shopping cart information.Shopping Cart
 * consists of {@link ShoppingCartItem} which represents individual lines items associated with the
 * shopping cart
 *
...
public class ShoppingCart extends SalesManagerEntity<Long, ShoppingCart> implements Auditable {
  ...
  /**
   * Will be used to fetch shopping cart model from the controller this is a unique code that should
   * be attributed from the client (UI)
   */
