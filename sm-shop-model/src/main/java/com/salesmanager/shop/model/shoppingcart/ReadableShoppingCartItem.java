 ...
 * @author c.samson
 */
public class ReadableShoppingCartItem extends ReadableProducts implements Serializable {
  ...
  private List<ReadableShoppingCartAttribute> cartItemattributes =
      new ArrayList<ReadableShoppingCartAttribute>();
