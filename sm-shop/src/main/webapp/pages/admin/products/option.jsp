				...
				<form:form method="POST" modelAttribute="option" action="${optionSave}">
                 ...
                 <div class="control-group">
                  ...
                  <form:hidden path="descriptionsList[${counter.index}].id" />
      			 ...
      			 <div class="control-group">
                        <label><s:message code="label.product.productoptions.feature" text="Option Feature"/></label>
                        <div class="controls">
                                   
	                       <div class="controls">
                                    <form:select path="productOptionFeature">
                                        <s:message code="label.product.productoption.feature.flavour" text="Flavour" var="vFlavour"/>
                                        <s:message code="label.product.productoption.feature.boost" text="Boost" var="vBoost"/>
                                        <s:message code="label.product.productoption.feature.pack" text="Pack" var="vPack"/>
                                        <form:option value="flavour" label="${vFlavour}" />
                                        <form:option value="boost" label="${vBoost}" />
                                        <form:option value="pack" label="${vPack}" />
                                    </form:select>
                                    <span class="help-inline"><form:errors path="productOptionFeature" cssClass="error" /></span>
                            </div>
