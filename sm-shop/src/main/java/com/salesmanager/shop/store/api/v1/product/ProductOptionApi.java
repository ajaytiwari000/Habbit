...
@Api(
    tags = {
      "Product attributes /options / options values management resource (Product Option Management Api)"
    })
@SwaggerDefinition(
    tags = {
      @Tag(
          name = "Product attributes /options / options values management resource",
          description = "Edit product attributes / options and product option values")
    })
public class ProductOptionApi {

  @Autowired private ProductOptionFacade productOptionFacade;
  ...
  @ApiOperation(
      httpMethod = "GET",
      value = "Check if option code already exists",
      notes = "",
  ...
  @ApiOperation(
      httpMethod = "GET",
      value = "Check if option value code already exists",
      notes = "",
      response = EntityExists.class)
  ...
  public @ResponseBody ReadableProductOptionValueEntity createOptionValue(
    ...
    ReadableProductOptionValueEntity entity =
