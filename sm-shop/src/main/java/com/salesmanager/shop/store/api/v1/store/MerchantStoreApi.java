...
@SwaggerDefinition(
    tags = {
      @Tag(
          name = "Merchant and store management",
          description = "Edit merchants (retailers) and stores")
    })
public class MerchantStoreApi {
  ...
  public ReadableMerchantStore store(
      @PathVariable String code, @RequestParam(value = "lang", required = false) String lang) {
  ...
  @ApiOperation(
      httpMethod = "GET",
      value = "Get retailer child stores",
      notes = "Merchant (retailer) can have multiple stores",
      response = ReadableMerchantStore.class)
  ...
  public ReadableMerchantStoreList list(
    ...
    userFacade.authorizedGroup(
        authenticatedUser,
        Stream.of("SUPERADMIN", "ADMIN", "ADMIN_RETAILER").collect(Collectors.toList()));
  ...
  @ApiOperation(
      httpMethod = "GET",
      value = "Get list of store names. Returns all retailers and stores",
      notes = "",
      response = ReadableMerchantStore.class)
  public List<ReadableMerchantStore> get(
    ...
    if (merchantStore != null) {
      if (com.salesmanager.core.business.constants.Constants.DEFAULT_STORE.equals(
  ...
  @ApiOperation(
      httpMethod = "GET",
      value = "Get list of store supported languages.",
      notes = "",
      response = ReadableMerchantStore.class)
  ...
  @ApiOperation(
      httpMethod = "POST",
      value = "Create or save store branding and marketing details",
      notes = "",
      response = ReadableBrand.class)
  public void saveStoreMarketing(
      @PathVariable String code, @RequestBody PersistableBrand brand, HttpServletRequest request) {
    String userName = getUserFromRequest(request);
    validateUserPermission(userName, code);
