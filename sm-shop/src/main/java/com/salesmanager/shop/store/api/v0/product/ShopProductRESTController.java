...
public class ShopProductRESTController {
  ...
  @ResponseBody
  public PersistablesProduct createProduct(
  ...
  public PersistableManufacturer createManufacturer(
    ...
    try {
      ...
      com.salesmanager.core.model.catalog.product.manufacturer.Manufacturer manuf =
          new com.salesmanager.core.model.catalog.product.manufacturer.Manufacturer();
  ...
  @ResponseStatus(HttpStatus.CREATED)
  @ResponseBody
  public PersistableProductOptionValue createProductOptionValue(
      @PathVariable final String store,
    ...
    try {
      ...
      PersistableProductOptionValuePopulator populator =
          new PersistableProductOptionValuePopulator();
      populator.setLanguageService(languageService);

      com.salesmanager.core.model.catalog.product.attribute.ProductOptionValue optValue =
          new com.salesmanager.core.model.catalog.product.attribute.ProductOptionValue();
  ...
  @ResponseStatus(HttpStatus.CREATED)
  @ResponseBody
  public PersistableProductOption createProductOption(
      @PathVariable final String store,
      @Valid @RequestBody PersistableProductOption option,
      HttpServletRequest request,
      HttpServletResponse response)
      throws Exception {
    ...
    try {
      ...
      com.salesmanager.core.model.catalog.product.attribute.ProductOption opt =
          new com.salesmanager.core.model.catalog.product.attribute.ProductOption();
  ...
  @ResponseStatus(HttpStatus.CREATED)
  @ResponseBody
  public PersistableProductReview createProductReview(
      @PathVariable final String store,
  ...
  @ResponseBody
  public ReadableProductsList getProducts(
  ...
  /*	*/
  /**
   * Will get products for a given category supports language by setting land as a query parameter
  ...
  */
   ...
   */
  @RequestMapping(
      "/products/public/page/{start}/{max}/{store}/{language}/{category}.html/filter={filterType}/filter-value={filterValue}")
  @ResponseBody
  public ReadableProductsList getProductsFilteredByType(
  ...
  private ReadableProductsList getProducts(
      final int start,
      final int max,
      final String store,
  ...
  public ReadableProducts updateProductPrice(
      @PathVariable final String store,
      @Valid @RequestBody ProductPriceEntity price,
    ...
    try {
      ...
      ReadableProducts product = productFacade.getProduct(merchantStore, sku, language);
  ...
  @RequestMapping(
      value = "/private/{store}/product/quantity/{sku}/{qty}",
