...
public class JWTAdminAuthenticationProvider extends DaoAuthenticationProvider {
  ...
  @Autowired private UserDetailsService jwtAdminDetailsService;
  ...
  /**
   * Please check {@link com.salesmanager.shop.store.security.admin.JWTAdminServicesImpl} for
   * loadUserByUsername API
   *
