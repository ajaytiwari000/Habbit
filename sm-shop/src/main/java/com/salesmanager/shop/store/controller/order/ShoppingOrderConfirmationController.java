...
public class ShoppingOrderConfirmationController extends AbstractController {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(ShoppingOrderConfirmationController.class);
  ...
  public String displayConfirmation(
    ...
    String orderEmailMessage =
        messages.getMessage("label.checkout.email", orderEmailParams, locale);
    ...
    StringBuilder template =
        new StringBuilder()
            .append(ControllerConstants.Tiles.Checkout.confirmation)
            .append(".")
