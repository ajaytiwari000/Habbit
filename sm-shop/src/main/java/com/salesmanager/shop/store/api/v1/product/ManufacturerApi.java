...
public class ManufacturerApi {
  ...
  @ApiOperation(
      httpMethod = "GET",
      value = "List manufacturers by store",
      notes = "This request supports paging or not. Paging supports page number and request count",
  ...
  @ApiOperation(
      httpMethod = "GET",
      value = "Check if manufacturer code already exists",
      notes = "",
