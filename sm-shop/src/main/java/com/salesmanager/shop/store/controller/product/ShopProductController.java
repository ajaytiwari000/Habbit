...
public class ShopProductController {
  ...
  public String display(
    ...
    Breadcrumb breadCrumb =
        breadcrumbsUtils.buildProductBreadcrumb(
            reference, productProxy, store, language, request.getContextPath());
    ...
    Map<Long, List<ReadableProducts>> relatedItemsMap = null;
    List<ReadableProducts> relatedItems = null;

    if (store.isUseCache()) {

      // get from the cache
      relatedItemsMap =
          (Map<Long, List<ReadableProducts>>) cache.getFromCache(relatedItemsCacheKey.toString());
      if (relatedItemsMap == null) {
        ...
        if (relatedItems != null) {
          relatedItemsMap = new HashMap<Long, List<ReadableProducts>>();
    ...
    StringBuilder template =
        new StringBuilder()
            .append(ControllerConstants.Tiles.Product.product)
            .append(".")
  ...
  @RequestMapping(
      value = {"/{productId}/calculatePrice.json"},
      method = RequestMethod.POST)
  public @ResponseBody ReadableProductPrice calculatePrice(
      @RequestParam(value = "attributeIds[]") Long[] attributeIds,
    ...
    List<ProductAttribute> attributes =
        productAttributeService.getByAttributeIds(store, product, ids);
  ...
  private List<ReadableProducts> relatedItems(
