...
public class LandingController {
  ...
  @RequestMapping(
      value = {Constants.SHOP_URI + "/home.html", Constants.SHOP_URI + "/", Constants.SHOP_URI},
  ...
  public String displayLanding(
    ...
    List<ProductRelationship> relationships =
        productRelationshipService.getByType(
            store, ProductRelationshipType.FEATURED_ITEM, language);
    List<ReadableProducts> featuredItems = new ArrayList<ReadableProducts>();
    Date today = new Date();
  ...
  @RequestMapping(
      value = {Constants.SHOP_URI + "/stub.html"},
      method = RequestMethod.GET)
  public String displayHomeStub(
      Model model, HttpServletRequest request, HttpServletResponse response, Locale locale)
      throws Exception {
    return "index";
  }
  ...
  public String displayStoreLanding(
