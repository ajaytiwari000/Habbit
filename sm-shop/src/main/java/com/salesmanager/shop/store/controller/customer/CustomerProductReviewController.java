...
public class CustomerProductReviewController extends AbstractController {
  ...
  public String displayProductReview(
    ...
    readableProductsPopulator.populate(product, readableProducts, store, language);
    model.addAttribute("product", readableProducts);
    ...
    StringBuilder template =
        new StringBuilder()
            .append(ControllerConstants.Tiles.Customer.review)
            .append(".")
  ...
  public String submitProductReview(
      @ModelAttribute("review") PersistableProductReview review,
