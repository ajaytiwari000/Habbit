...
public class ProductOptionFacadeImpl implements ProductOptionFacade {
  ...
  @Autowired private ProductOptionValueService productOptionValueService;

  @Autowired private ReadableProductOptionMapper readableMapper;

  @Autowired private PersistableProductOptionMapper persistableeMapper;

  @Autowired private PersistableProductOptionValueMapper persistableOptionValueMapper;

  @Autowired private ReadableProductOptionValueMapper readableOptionValueMapper;
  ...
  @Autowired private ReadableProductAttributeMapper readableProductAttributeMapper;
  ...
  public ReadableProductOptionValueList optionValues(
    ...
    List<ReadableProductOptionValueEntity> values =
  ...
  @Override
  public ReadableProductOptionValueEntity saveOptionValue(
    ...
    // convert to readable
    ReadableProductOptionValueEntity readableProductOptionValue =
        new ReadableProductOptionValueEntity();
    readableProductOptionValue =
        readableOptionValueMapper.convert(optValue, readableProductOptionValue, store, language);
  ...
  public ReadableProductAttributeList getAttributesList(
      Long productId, MerchantStore store, Language language) {
