...
@SwaggerDefinition(
    tags = {
      @Tag(
          name = "Content management resource",
          description = "Add pages, content boxes, manage images and files")
    })
public class ContentApi {
  ...
  @ApiOperation(
      httpMethod = "GET",
      value =
          "Get pages summary created for a given MerchantStore. Content summary is a content bux having code summary.",
      notes = "",
      produces = "application/json",
      response = List.class)
  @ApiImplicitParams({
  ...
  @ApiOperation(
      ...
      notes = "",
      produces = "application/json",
      response = ReadableContentPage.class)
  @ApiImplicitParams({
    @ApiImplicitParam(name = "store", dataType = "String", defaultValue = "DEFAULT"),
    @ApiImplicitParam(name = "lang", dataType = "String", defaultValue = "en")
  })
  ...
  @ApiOperation(
      httpMethod = "GET",
      value = "Get contents (page and boc) for a given MerchantStore",
      notes = "",
      produces = "application/json",
      response = ReadableContentPage.class)
  @ApiImplicitParams({
  ...
  @ApiOperation(
      httpMethod = "GET",
      value = "Get store content images",
      notes = "",
  ...
  @ResponseStatus(HttpStatus.CREATED)
  @ApiImplicitParams({
    // @ApiImplicitParam(name = "file[]", value = "File stream object", required = true,dataType =
    // "MultipartFile",allowMultiple = true),
    @ApiImplicitParam(name = "store", dataType = "String", defaultValue = "DEFAULT"),
    @ApiImplicitParam(name = "lang", dataType = "String", defaultValue = "en")
  })
  ...
  @ApiOperation(
      httpMethod = "POST",
      value = "Create content (page or box)",
      notes = "content type is by default BOX, when creating a page specify contentType:PAGE",
      response = Void.class)
  @ApiImplicitParams({
    @ApiImplicitParam(name = "store", dataType = "String", defaultValue = "DEFAULT"),
    @ApiImplicitParam(name = "lang", dataType = "String", defaultValue = "en")
  ...
  @ApiOperation(
      httpMethod = "PUT",
      value = "Update content page",
      notes = "Updates a content page",
      response = Void.class)
  @ApiImplicitParams({
    @ApiImplicitParam(name = "store", dataType = "String", defaultValue = "DEFAULT"),
    @ApiImplicitParam(name = "lang", dataType = "String", defaultValue = "en")
  ...
  @ApiOperation(
      httpMethod = "DELETE",
      value = "Deletes a content from CMS",
      notes = "Delete a content box or page",
      response = Void.class)
  @ApiImplicitParams({
    @ApiImplicitParam(name = "store", dataType = "String", defaultValue = "DEFAULT")
  })
  ...
  @ApiOperation(
      httpMethod = "DELETE",
      value = "Deletes a file from CMS",
      notes = "Delete a file from server",
      response = Void.class)
  @ApiImplicitParams({
    @ApiImplicitParam(name = "store", dataType = "String", defaultValue = "DEFAULT"),
    @ApiImplicitParam(name = "lang", dataType = "String", defaultValue = "en")
