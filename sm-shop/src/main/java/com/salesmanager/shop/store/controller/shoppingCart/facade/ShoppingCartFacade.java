...
/**
 * Shopping cart Facade which provide abstraction layer between SM core module and Controller. Only
 * Data Object will be exposed to controller by hiding model object from view.
 *
...
public interface ShoppingCartFacade {
  ...
  public ShoppingCart createCartModel(
      ...
      throws Exception;
  /** Method responsible for getting shopping cart from either session or from underlying DB. */
  /**
   * jsp cart methods
   *
  ...
  ShoppingCartData updateCartItems(
  ...
  /**
   * Get ShoppingCart This method is used by the API
   *
   * @param customer
   * @param store
   * @param language
  ...
  void removeShoppingCartItem(
      String cartCode, Long productId, MerchantStore merchant, Language languag) throws Exception;

  /**
   * Add product to ShoppingCart This method is used by the API
   *
   * @param customer
   * @param item
   * @param store
