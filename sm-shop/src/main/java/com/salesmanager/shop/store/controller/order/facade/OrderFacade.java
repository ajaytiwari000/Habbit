...
public interface OrderFacade {
  ...
  /**
   * Method used to fetch all orders associated with customer customer. It will used current
   * customer ID to fetch all orders which has been placed by customer for current store.
   *
   ...
   * @throws Exception
   */
  ReadableOrderList getReadableOrderList(
   ...
   * @throws Exception
   */
  ReadableOrderList getCapturableOrderList(
   ...
   * @throws Exception
   */
  ReadableTransaction captureOrder(
