...
public class ShoppingCartFacadeImpl implements ShoppingCartFacade {
  ...
  @Inject ShoppingCartCalculationService shoppingCartCalculationService;
  ...
  public ShoppingCartData addItemsToShoppingCart(
    ...
    /**
     * Sometimes a user logs in and a shopping cart is present in db (shoppingCartData but ui has no
     * cookie with shopping cart code so the cart code will have to be added to the item in order to
     * process add to cart normally
     */
    ...
    if (CollectionUtils.isEmpty(item.getShoppingCartAttributes())) { // increment quantity
      ...
      Set<com.salesmanager.core.model.shoppingcart.ShoppingCartItem> cartModelItems =
    ...
    if (!duplicateFound) {
      // shoppingCartItem.getAttributes().stream().forEach(a ->
      // {a.setProductAttributeId(productAttributeId);});
  ...
  private com.salesmanager.core.model.shoppingcart.ShoppingCartItem createCartItem(
    ...
    /**
     * Check if product quantity is 0 Check if product is available Check if date available <= now
     */
      ...
      for (ShoppingCartAttribute attribute : cartAttributes) {
        ...
        if (productAttribute != null
          ...
          com.salesmanager.core.model.shoppingcart.ShoppingCartAttributeItem attributeItem =
              new com.salesmanager.core.model.shoppingcart.ShoppingCartAttributeItem(
  ...
  // used for api
  private com.salesmanager.core.model.shoppingcart.ShoppingCartItem createCartItem(
      ShoppingCart cartModel, PersistableShoppingCartItem shoppingCartItem, MerchantStore store)
      throws Exception {
    ...
    if (product == null) {
      throw new ResourceNotFoundException(
          "Item with id " + shoppingCartItem.getProduct() + " does not exist");
    }
    ...
    // set attributes
    List<com.salesmanager.shop.model.catalog.product.attribute.ProductAttribute> attributes =
        shoppingCartItem.getAttributes();
    if (!CollectionUtils.isEmpty(attributes)) {
      for (com.salesmanager.shop.model.catalog.product.attribute.ProductAttribute attribute :
          attributes) {
  ...
  private com.salesmanager.core.model.shoppingcart.ShoppingCartItem getEntryToUpdate(
    ...
    if (CollectionUtils.isNotEmpty(cartModel.getLineItems())) {
      for (com.salesmanager.core.model.shoppingcart.ShoppingCartItem shoppingCartItem :
          cartModel.getLineItems()) {
  ...
  // @Override
  public ShoppingCartData getShoppingCartData(
      final ShoppingCart shoppingCartModel, Language language) throws Exception {
  ...
  public ShoppingCartData removeCartItem(
      final Long itemID, final String cartId, final MerchantStore store, final Language language)
      throws Exception {
  ...
  public ShoppingCartData updateCartItems(
    ...
    ShoppingCart cartModel = null;
    Set<com.salesmanager.core.model.shoppingcart.ShoppingCartItem> cartItems =
        new HashSet<com.salesmanager.core.model.shoppingcart.ShoppingCartItem>();
  ...
  public ReadableShoppingCart addToCart(
      PersistableShoppingCartItem item, MerchantStore store, Language language) throws Exception {
  ...
  public void removeShoppingCartItem(
      String cartCode, Long productId, MerchantStore merchant, Language language) throws Exception {
    ...
    Set<com.salesmanager.core.model.shoppingcart.ShoppingCartItem> items =
        new HashSet<com.salesmanager.core.model.shoppingcart.ShoppingCartItem>();
  ...
  private ReadableShoppingCart readableShoppingCart(
    ...
    com.salesmanager.core.model.shoppingcart.ShoppingCartItem itemModel =
        createCartItem(cartModel, item, store);
  ...
  private ReadableShoppingCart modifyCart(
    ...
    if (!CollectionUtils.isEmpty(items)) {
      Set<com.salesmanager.core.model.shoppingcart.ShoppingCartItem> newItems =
          new HashSet<com.salesmanager.core.model.shoppingcart.ShoppingCartItem>();
      Set<com.salesmanager.core.model.shoppingcart.ShoppingCartItem> removeItems =
          new HashSet<com.salesmanager.core.model.shoppingcart.ShoppingCartItem>();
      for (com.salesmanager.core.model.shoppingcart.ShoppingCartItem anItem :
          items) { // take care of existing product
  ...
  @Override
  public ReadableShoppingCart addToCart(
      Customer customer, PersistableShoppingCartItem item, MerchantStore store, Language language)
      throws Exception {
  ...
  public ReadableShoppingCart modifyCart(
      String cartCode, PersistableShoppingCartItem item, MerchantStore store, Language language)
      throws Exception {
