...
@SwaggerDefinition(
    tags = {
      @Tag(
          name = "Product inventory resource",
          description = "Manage inventory for a given product")
    })
public class ProductInventoryApi {

  @Autowired private ProductInventoryFacade productInventoryFacade;
  ...
  public @ResponseBody ReadableInventory create(
    ...
    ReadableInventory returnObject =
        productInventoryFacade.add(inventory.getProductId(), inventory, merchantStore, language);
    return returnObject;
  }
