...
public class RestErrorHandler {
  ...
  public @ResponseBody ErrorEntity handleServiceException(Exception exception) {
    ...
    ErrorEntity errorEntity =
        createErrorEntity(null, exception.getMessage(), exception.getLocalizedMessage());
    return errorEntity;
  }
  ...
  public @ResponseBody ErrorEntity handleServiceException(ServiceRuntimeException exception) {
    ...
    ErrorEntity errorEntity =
        createErrorEntity(
            exception.getErrorCode(), exception.getErrorMessage(), exception.getLocalizedMessage());
    return errorEntity;
  }
  ...
  @ResponseStatus(HttpStatus.BAD_REQUEST)
  public @ResponseBody ErrorEntity handleServiceException(IllegalArgumentException exception) {
    log.error(exception.getMessage(), exception);
    ErrorEntity errorEntity =
        createErrorEntity("400", exception.getMessage(), exception.getLocalizedMessage());
    return errorEntity;
  }
  ...
  @ResponseStatus(HttpStatus.BAD_REQUEST)
  public @ResponseBody ErrorEntity handleServiceException(ResourceDuplicateException exception) {
    log.error(exception.getErrorMessage(), exception);
    ErrorEntity errorEntity =
        createErrorEntity(
            exception.getErrorCode(), exception.getErrorMessage(), exception.getLocalizedMessage());
  ...
  @RequestMapping(produces = "application/json")
  @ExceptionHandler({CustomAuthenticationException.class, ForbiddenException.class})
  @ResponseStatus(HttpStatus.FORBIDDEN)
  public @ResponseBody ErrorEntity handleServiceException(CustomAuthenticationException exception) {
    log.error(exception.getErrorMsg(), exception);

    ErrorEntity errorEntity =
        createErrorEntity(
            exception.getErrorCode(), exception.getErrorMsg(), exception.getLocalizedMessage());
    return errorEntity;
  }
