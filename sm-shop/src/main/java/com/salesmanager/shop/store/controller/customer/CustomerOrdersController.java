...
public class CustomerOrdersController extends AbstractController {
  ...
  public String listOrders(
    ...
    ReadableOrderList readable =
        orderFacade.getReadableOrderList(
            store,
            customer,
            (paginaionData.getOffset() - 1),
            paginaionData.getPageSize(),
            language);
    ...
    StringBuilder template =
        new StringBuilder()
            .append(ControllerConstants.Tiles.Customer.customerOrders)
            .append(".")
  ...
  public String orderDetails(
    ...
    ReadableOrder order =
        orderFacade.getReadableOrder(lOrderId, store, customer.getDefaultLanguage());
    ...
    StringBuilder template =
        new StringBuilder()
            .append(ControllerConstants.Tiles.Customer.customerOrder)
            .append(".")
            .append(store.getStoreTemplate());
    return template.toString();
  }
