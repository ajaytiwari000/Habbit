...
public class CustomerLoginController extends AbstractController {
  ...
  private AjaxResponse logon(
    ...
    try {
      ...
      jsonObject.addEntry(Constants.RESPONSE_KEY_USERNAME, customerModel.getUserName());
      ...
      if (!StringUtils.isBlank(sessionShoppingCartCode)) {
        ShoppingCart shoppingCart =
            customerFacade.mergeCart(customerModel, sessionShoppingCartCode, store, language);
        if (shoppingCart != null) {
          ShoppingCartData shoppingCartData =
              this.populateShoppingCartData(shoppingCart, store, language);
      ...
      cookieValue.append(store.getCode()).append("_").append(customerModel.getUserName());
  ...
  public @ResponseBody String basicLogon(
  ...
  public @ResponseBody String jsonLogon(
      @ModelAttribute SecuredCustomer securedCustomer,
      HttpServletRequest request,
      HttpServletResponse response)
      throws Exception {

    AjaxResponse jsonObject =
        this.logon(
            securedCustomer.getUserName(),
            securedCustomer.getPassword(),
            securedCustomer.getStoreCode(),
            request,
            response);
    return jsonObject.toJSONString();
  }
