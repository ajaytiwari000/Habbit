...
public class AuthenticateCustomerTestApi {

  private static final Logger LOGGER = LoggerFactory.getLogger(AuthenticateCustomerTestApi.class);
  ...
  public ResponseEntity<?> register(
    ...
    final JWTUser userDetails =
        (JWTUser) jwtCustomerDetailsService.loadUserByUsername(customer.getUserName());
    final String token = jwtTokenUtil.generateToken(userDetails, requestSource);
  ...
  @ApiOperation(
      ...
      notes =
          "Customer can authenticate after registration, request is {\"username\":\"admin\",\"password\":\"password\"}",
  ...
  public ResponseEntity<?> authenticate(
    ...
    final JWTUser userDetails =
        (JWTUser) jwtCustomerDetailsService.loadUserByUsername(authenticationRequest.getUsername());
  ...
  @RequestMapping(
      value = "/auth/customer/test/refresh",
  ...
  @RequestMapping(
      value = "/customer/password/test/reset",
