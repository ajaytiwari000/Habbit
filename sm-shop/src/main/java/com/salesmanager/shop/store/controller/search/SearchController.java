...
public class SearchController {
   ...
   */
  @RequestMapping(
      value = "/services/public/search/{store}/{language}/autocomplete.json",
  ...
  public String autocomplete(
    ...
    try {
      ...
      SearchKeywords keywords =
          searchService.searchForKeywords(
  ...
  public String displaySearch(
    ...
    StringBuilder template =
        new StringBuilder()
            .append(ControllerConstants.Tiles.Search.search)
            .append(".")
