...
public class SystemRESTController {
   ...
   *
   * <p>{ "module": "PAYMENT", "code": "paypal-express-checkout", "type":"paypal",
   * "version":"104.0", "regions": ["*"], "image":"icon-paypal.png",
   ...
   * <p>}
   *
   * <p>see : shopizer/sm-core/src/main/resources/reference/integrationmodules.json for more samples
   *
   * @param json
   * @param request
   * @param response
  ...
  public AjaxResponse deleteOptin(
      @RequestBody final String code, HttpServletRequest request, HttpServletResponse response)
      throws Exception {
  ...
  @RequestMapping(
      value = "/private/system/optin/{code}/customer",
      method = RequestMethod.POST,
