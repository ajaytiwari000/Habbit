...
public class ProductItemsFacadeImpl implements ProductItemsFacade {
  ...
  @Override
  public ReadableProductsList listItemsByManufacturer(
    ...
    com.salesmanager.core.model.catalog.product.ProductList products =
        productService.listByStore(store, language, productCriteria);
  ...
  @Override
  public ReadableProductsList listItemsByGroup(String group, MerchantStore store, Language language)
      throws Exception {
    ...
    if (group != null) {
      ...
      ReadableProductsList list = listItemsByIds(store, language, ids, 0, 0);
      return list;
    }
  ...
  @Override
  public ReadableProductsList addItemToGroup(
              ...
              .filter(
                  prod ->
                      prod.getRelatedProduct() != null
                          && (product.getId().longValue() == prod.getRelatedProduct().getId()))
  ...
  @Override
  public ReadableProductsList removeItemFromGroup(
