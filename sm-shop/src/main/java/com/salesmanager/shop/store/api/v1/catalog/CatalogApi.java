...
@SwaggerDefinition(
    tags = {
      @Tag(
          name = "Catalog management resource",
          description = "Manage catalogs and attached products")
    })
public class CatalogApi {

  private static final Logger LOGGER = LoggerFactory.getLogger(CatalogApi.class);

  @Autowired private CatalogFacade catalogFacade;

  @GetMapping(value = "/private/catalogs")
  @ResponseStatus(HttpStatus.OK)
  @ApiOperation(
      httpMethod = "GET",
      value = "Get catalogs by merchant",
      notes = "",
  ...
  @ApiOperation(
      httpMethod = "GET",
      value = "Check if catalog code already exists",
      notes = "",
  ...
  @ResponseStatus(HttpStatus.OK)
  @ApiOperation(httpMethod = "POST", value = "Create catalog", notes = "", response = Void.class)
  @ApiImplicitParams({
    @ApiImplicitParam(name = "store", dataType = "String", defaultValue = "DEFAULT"),
    @ApiImplicitParam(name = "lang", dataType = "String", defaultValue = "en")
  })
  ...
  @ResponseStatus(HttpStatus.OK)
  @ApiOperation(httpMethod = "PATCH", value = "Update catalog", notes = "", response = Void.class)
  @ApiImplicitParams({
    @ApiImplicitParam(name = "store", dataType = "String", defaultValue = "DEFAULT"),
    @ApiImplicitParam(name = "lang", dataType = "String", defaultValue = "en")
  })
  ...
  @ResponseStatus(HttpStatus.OK)
  @ApiOperation(httpMethod = "GET", value = "Get catalog", notes = "", response = Void.class)
  @ApiImplicitParams({
    @ApiImplicitParam(name = "store", dataType = "String", defaultValue = "DEFAULT"),
    @ApiImplicitParam(name = "lang", dataType = "String", defaultValue = "en")
  })
  ...
  @ApiOperation(
      httpMethod = "POST",
      value = "Add catalog entry to catalog",
      notes = "",
  ...
  @ApiOperation(
      httpMethod = "DELETE",
      value = "Remove catalog entry from catalog",
      notes = "",
      response = Void.class)
  @ApiImplicitParams({
    @ApiImplicitParam(name = "store", dataType = "String", defaultValue = "DEFAULT"),
  ...
  @ApiOperation(
      httpMethod = "GET",
      value = "Get catalog entry by catalog",
      notes = "",
