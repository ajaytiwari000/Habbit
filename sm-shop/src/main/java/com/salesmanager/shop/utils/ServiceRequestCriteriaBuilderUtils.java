...
public class ServiceRequestCriteriaBuilderUtils {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(ServiceRequestCriteriaBuilderUtils.class);
  ...
  public static Criteria buildRequestCriterias(
    ...
    if (criteria == null) throw new RestApiException("A criteria class type must be instantiated");

    mappingFields.keySet().stream()
        .forEach(
            p -> {
              try {
