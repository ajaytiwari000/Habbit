...
public class BreadcrumbsUtils {
  ...
  public Breadcrumb buildCategoryBreadcrumb(
      ReadableCategorys categoryClicked, MerchantStore store, Language language, String contextPath)
      throws Exception {
  ...
  public Breadcrumb buildProductBreadcrumb(
      String refContent,
      ReadableProducts productClicked,
      MerchantStore store,
      Language language,
      String contextPath)
      throws Exception {
    ...
    productBreadcrump.setUrl(
        filePathUtils.buildProductUrl(
            store, contextPath, productClicked.getDescription().getFriendlyUrl()));
