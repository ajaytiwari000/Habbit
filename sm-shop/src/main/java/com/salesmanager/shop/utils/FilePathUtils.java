...
public class FilePathUtils {
   ...
   * the physical image Example: /files/<storeCode>/
   */
  ...
  /**
   * Example: /<baseImagePath>/files/<storeCode>/STATIC_FILE/<fileName> Or example:
   * /<shopScheme>://<domainName>/<contextPath>/files/<storeCode>/
   */
  ...
  private String buildBaseUrl(HttpServletRequest request, MerchantStore store) {
    ...
    return scheme + DOUBLE_SLASH + domainName + contextPath;
  }
}
