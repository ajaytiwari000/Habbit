...
public class DocumentationConfiguration {
  ...
  public static final Contact DEFAULT_CONTACT =
      new Contact("Shopizer", "http://www.shopizer.com", "");
  ...
  private ApiInfo apiInfo() {
    return new ApiInfo(
        "Habbit REST API",
        "API for Habbit e-commerce. Contains public end points as well as private end points requiring basic authentication and remote authentication based on jwt bearer token. URL patterns containing /private/** use bearer token; those are authorized customer and administrators administration actions.",
        "1.0",
        "urn:tos",
        DEFAULT_CONTACT,
        "Apache 2.0",
  ...
  private static ArrayList<? extends SecurityScheme> securitySchemes() {
    return (ArrayList<? extends SecurityScheme>)
        Stream.of(new ApiKey("Bearer", "Authorization", "header")).collect(Collectors.toList());
  }
}
