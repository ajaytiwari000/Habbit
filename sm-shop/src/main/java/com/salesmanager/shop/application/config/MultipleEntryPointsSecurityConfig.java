...
import com.salesmanager.shop.store.facade.customer.CustomerFacadeImpl;
...
public class MultipleEntryPointsSecurityConfig {
  ...
  public static class CustomerConfigurationAdapter extends WebSecurityConfigurerAdapter {
    ...
    @Autowired private UserDetailsService customerDetailsService;
    ...
    protected void configure(HttpSecurity http) throws Exception {
      http.antMatcher("/shop/**")
          ...
          .antMatchers("/shop/**")
          .permitAll()
          .antMatchers("/shop/customer/logon*")
          .permitAll()
          .antMatchers("/shop/customer/registration*")
          .permitAll()
          .antMatchers("/shop/customer/logout*")
          .permitAll()
          .antMatchers("/shop/customer/customLogon*")
          .permitAll()
          .antMatchers("/shop/customer/denied*")
          .permitAll()
          .antMatchers("/shop/customer/**")
  ...
  public static class ServicesApiConfigurationAdapter extends WebSecurityConfigurerAdapter {
    ...
    @Autowired private ServicesAuthenticationSuccessHandler servicesAuthenticationSuccessHandler;
    ...
    protected void configure(HttpSecurity http) throws Exception {
      http.antMatcher("/services/**")
          ...
          .disable()
          .authorizeRequests()
          .antMatchers("/services/public/**")
          .permitAll()
          .antMatchers("/services/private/**")
          .hasRole("AUTH")
          .anyRequest()
          .authenticated()
          .and()
  ...
  public static class AdminConfigurationAdapter extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
      http.antMatcher("/admin/**")
          .authorizeRequests()
          .antMatchers("/admin/logon*")
          .permitAll()
          .antMatchers("/admin/resources/**")
          .permitAll()
          .antMatchers("/admin/layout/**")
          .permitAll()
          .antMatchers("/admin/denied*")
          .permitAll()
          .antMatchers("/admin/unauthorized*")
          .permitAll()
          .antMatchers("/admin/users/resetPassword*")
          .permitAll()
          .antMatchers("/admin/")
          .hasRole("AUTH")
          .antMatchers("/admin/**")
          ...
          .antMatchers("/admin/**")
          .hasRole("AUTH")
          .antMatchers("/admin/users/resetPasswordSecurityQtn*")
          .permitAll()
          .anyRequest()
          .authenticated()
          .and()
  ...
  public static class ApiConfigurationAdapter extends WebSecurityConfigurerAdapter {
    ...
    @Autowired JWTAdminServicesImpl jwtUserDetailsService;
    ...
    @Override
    protected void configure(HttpSecurity http) throws Exception {
      http.antMatcher(API_V1 + "/private/**")
          .authorizeRequests()
          .antMatchers(API_V1 + "/private/login*")
          .permitAll()
          .antMatchers(API_V1 + "/private/test/login*")
          .permitAll()
          .antMatchers(API_V1 + "/private/refresh")
          .permitAll()
          .antMatchers(API_V1 + "/private/test/refresh")
          .permitAll()
          .antMatchers(HttpMethod.OPTIONS, API_V1 + "/private/**")
          .permitAll()
          .antMatchers(API_V1 + "/private/**")
          .hasRole("AUTH")
          .anyRequest()
          .authenticated()
          .and()
  ...
  public static class CustomeApiConfigurationAdapter extends WebSecurityConfigurerAdapter {
    ...
    @Autowired private UserDetailsService jwtCustomerDetailsService;
    ...
    @Override
    protected void configure(HttpSecurity http) throws Exception {
      http.antMatcher(API_V1 + "/auth/**")
          .authorizeRequests()
          .antMatchers(API_V1 + "/auth/refresh")
          .permitAll()
          .antMatchers(API_V1 + "/auth/login")
          .permitAll()
          .antMatchers(API_V1 + "/auth/test/login")
          .permitAll()
          .antMatchers(API_V1 + "/auth/test/register")
          .permitAll()
          .antMatchers(HttpMethod.OPTIONS, API_V1 + "/auth/**")
          .permitAll()
