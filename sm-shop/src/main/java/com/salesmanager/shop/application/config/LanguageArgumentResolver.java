...
public class LanguageArgumentResolver implements HandlerMethodArgumentResolver {
  ...
  @Autowired private MerchantStoreArgumentResolver merchantStoreArgumentResolver;
  ...
  public Object resolveArgument(
    ...
    MerchantStore merchantStore =
        getMerchantStore(parameter, mavContainer, webRequest, binderFactory);
  ...
  private MerchantStore getMerchantStore(
    ...
    return (MerchantStore)
        merchantStoreArgumentResolver.resolveArgument(
