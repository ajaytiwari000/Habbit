...
public class InitializationLoader {
  ...
  @Inject private InitializationDatabase initializationDatabase;

  @Inject private InitData initData;

  @Inject private SystemConfigurationService systemConfigurationService;
  ...
  public void init() {
    ...
    try {
      ...
      if (initializationDatabase.isEmpty()) {
        ...
        org.springframework.core.io.Resource permissionXML =
            resourceLoader.getResource("classpath:/permission/permission.json");
  ...
  private void loadData() throws ServiceException {
    ...
    boolean loadData =
        !StringUtils.isBlank(loadTestData)
    ...
    if (loadData) {
      ...
      SystemConfiguration configuration =
          systemConfigurationService.getByKey(ApplicationConstants.TEST_DATA_LOADED);
