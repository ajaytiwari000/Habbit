...
public class ReadableManufacturerMapper implements Mapper<Manufacturer, ReadableManufacturer> {
  ...
  private Optional<com.salesmanager.shop.model.catalog.manufacturer.ManufacturerDescription>
  ...
  private Optional<ManufacturerDescription> getDescription(
    ...
    Optional<ManufacturerDescription> descriptionByLang =
        descriptionsLang.stream()
  ...
  private com.salesmanager.shop.model.catalog.manufacturer.ManufacturerDescription
