...
@Component
public class PersistableCatalogEntryMapper
    implements Mapper<PersistableCatalogEntry, CatalogEntry> {
  ...
  @Override
  public CatalogEntry convert(
      PersistableCatalogEntry source, MerchantStore store, Language language) {
  ...
  @Override
  public CatalogEntry convert(
      PersistableCatalogEntry source,
    ...
    try {
      ...
      if (catalogModel == null) {
        throw new ConversionRuntimeException(
            "Error while converting CatalogEntry product [" + source.getCatalog() + "] not found");
      }
