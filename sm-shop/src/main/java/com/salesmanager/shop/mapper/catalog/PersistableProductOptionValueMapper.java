...
public class PersistableProductOptionValueMapper
  ...
  public ProductOptionValue convert(
      PersistableProductOptionValueEntity source,
    ...
    try {
      ...
      if (!CollectionUtils.isEmpty(source.getDescriptions())) {
        for (com.salesmanager.shop.model.catalog.product.attribute.ProductOptionValueDescription
  ...
  @Override
  public ProductOptionValue convert(
      PersistableProductOptionValueEntity source, MerchantStore store, Language language) {
