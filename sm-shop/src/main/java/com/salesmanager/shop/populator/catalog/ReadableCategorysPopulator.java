...
public class ReadableCategorysPopulator extends AbstractDataPopulator<Category, ReadableCategorys> {

  @Override
  public ReadableCategorys populate(
      final Category source,
      final ReadableCategorys target,
  ...
  @Override
  protected ReadableCategorys createTarget() {
    return null;
  }
}
