...
/** Not Used in Habbit */
public class ReadableProductsPopulator extends AbstractDataPopulator<Product, ReadableProducts> {
  ...
  @Override
  public ReadableProducts populate(
      Product source, ReadableProducts target, MerchantStore store, Language language)
    ...
    try {
      ...
      List<com.salesmanager.shop.model.catalog.product.ProductDescription> fulldescriptions =
          new ArrayList<com.salesmanager.shop.model.catalog.product.ProductDescription>();
      if (language == null) {
        target = new ReadableProductsFull();
      }

      if (target == null) {
        target = new ReadableProducts();
      }
      ...
      if (target instanceof ReadableProductsFull) {
        ((ReadableProductsFull) target).setDescriptions(fulldescriptions);
      }
      ...
      if (description != null) {
        com.salesmanager.shop.model.catalog.product.ProductDescription tragetDescription =
      ...
      if (!CollectionUtils.isEmpty(source.getCategories())) {
        ...
        List<ReadableCategorys> categoryList = new ArrayList<ReadableCategorys>();
        ...
        for (Category category : source.getCategories()) {
          ...
          categoryList.add(readableCategorys);
        }
      ...
      if (!CollectionUtils.isEmpty(source.getAttributes())) {
          ...
          for (ProductAttribute attribute : attributes) {
            ...
            if (attribute.getAttributeDisplayOnly()) { // read only attribute
              ...
              if (attribute.getProductOptionValue() != null) {
                attrValue.setId(
                    attribute.getProductOptionValue().getId()); // id of the option value
              } else {
              ...
              com.salesmanager.shop.model.catalog.product.attribute.ProductOptionValueDescription
                  valueDescription =
                      new com.salesmanager.shop.model.catalog.product.attribute
              ...
              if (attribute.getProductAttributePrice() != null
                ...
                String formatedPrice =
                    pricingService.getDisplayAmount(attribute.getProductAttributePrice(), store);
              ...
              if (!StringUtils.isBlank(
                ...
                optValue.setImage(
                    imageUtils.buildProductPropertyImageUtils(
                        store, attribute.getProductOptionValue().getProductOptionValueImage()));
              }
        ...
        if (selectableOptions != null) {
          List<ReadableProductOption> options =
              new ArrayList<ReadableProductOption>(selectableOptions.values());
      ...
      for (ProductAvailability a : source.getAvailabilities()) {
        // if(availability.getRegion().equals(Constants.ALL_REGIONS)) {//TODO REL 2.1 accept a
        // region
        availability = a;
            ...
            if (pr.isPresent()) {
              ...
              Optional<ProductPriceDescription> d =
                  pr.get().getDescriptions().stream()
                      ...
                      .findFirst();
              if (d.isPresent()) {
                com.salesmanager.shop.model.catalog.product.ProductPriceDescription
                    priceDescription =
  ...
  @Override
  protected ReadableProducts createTarget() {
    // TODO Auto-generated method stub
    return null;
  }

  com.salesmanager.shop.model.catalog.product.ProductDescription populateDescription(
