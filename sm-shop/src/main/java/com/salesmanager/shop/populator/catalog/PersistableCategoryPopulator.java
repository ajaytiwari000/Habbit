...
public class PersistableCategoryPopulator
    extends AbstractDataPopulator<PersistablesCategory, Category> {
  ...
  public Category populate(
      PersistablesCategory source, Category target, MerchantStore store, Language language)
    ...
    try {
      ...
      if (source.getParent() == null
        ...
        if (parent != null
            && parent.getMerchantStore().getId().intValue() != store.getId().intValue()) {
      ...
      if (!CollectionUtils.isEmpty(source.getChildren())) {
        ...
        for (PersistablesCategory cat : source.getChildren()) {
      ...
      if (!CollectionUtils.isEmpty(source.getDescriptions())) {
        Set<com.salesmanager.core.model.catalog.category.CategoryDescription> descriptions =
            new HashSet<com.salesmanager.core.model.catalog.category.CategoryDescription>();
        if (CollectionUtils.isNotEmpty(target.getDescriptions())) {
          for (com.salesmanager.core.model.catalog.category.CategoryDescription description :
          ...
          for (CategoryDescription d : source.getDescriptions()) {
            com.salesmanager.core.model.catalog.category.CategoryDescription t =
                new com.salesmanager.core.model.catalog.category.CategoryDescription();
  ...
  private com.salesmanager.core.model.catalog.category.CategoryDescription buildDescription(
      com.salesmanager.shop.model.catalog.category.CategoryDescription source,
      com.salesmanager.core.model.catalog.category.CategoryDescription target)
      throws Exception {
