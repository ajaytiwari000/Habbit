...
public class PersistableOrderProductPopulator
    extends AbstractDataPopulator<PersistableOrderProduct, OrderProduct> {
  ...
  public OrderProduct populate(
      PersistableOrderProduct source, OrderProduct target, MerchantStore store, Language language)
    ...
    try {
      ...
      if (!CollectionUtils.isEmpty(attributeItems)) {
        ...
        for (ProductAttribute attribute : attributeItems) {
          ...
          com.salesmanager.core.model.catalog.product.attribute.ProductAttribute attr =
              productAttributeService.getById(id);
          if (attr == null) {
