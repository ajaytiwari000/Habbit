...
public class PersistableOrderPopulator extends AbstractDataPopulator<PersistableOrder, Order> {
  ...
  public Order populate(
    ...
    try {
      ...
      CreditsCard creditsCard = source.getCreditsCard();
      if (creditsCard != null) {
        String maskedNumber = CreditCardUtils.maskCardNumber(creditsCard.getCcNumber());
        creditsCard.setCcNumber(maskedNumber);
      ...
      com.salesmanager.shop.populator.order.PersistableOrderProductPopulator orderProductPopulator =
          new PersistableOrderProductPopulator();
      ...
      if (CollectionUtils.isNotEmpty(orderTotals)) {
        for (OrderTotal total : orderTotals) {
          com.salesmanager.core.model.order.OrderTotal totalModel =
              new com.salesmanager.core.model.order.OrderTotal();
