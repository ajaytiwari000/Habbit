...
@Component
public class PersistableProductPopulator
    extends AbstractDataPopulator<PersistablesProduct, Product> {
  ...
  @Override
  public Product populate(
      PersistablesProduct source, Product target, MerchantStore store, Language language)
    ...
    try {
      ...
      if (!StringUtils.isBlank(source.getType())) {
        ...
        //	throw new ConversionException("Product type [" + source.getType() + "] does not exist for
        // store [" + store.getCode() + "]");
        // }
      ...
      if (source.getOwner() != null && source.getOwner().getId() != null) {
        com.salesmanager.core.model.customer.Customer owner =
            customerService.getById(source.getOwner().getId());
      ...
      if (!CollectionUtils.isEmpty(source.getDescriptions())) {
        for (com.salesmanager.shop.model.catalog.product.ProductDescription description :
      ...
      if (CollectionUtils.isNotEmpty(source.getProductPrices())) {
        ...
        for (com.salesmanager.shop.model.catalog.product.PersistableProductPrice priceEntity :
          ...
          for (Language lang : languages) {
            ...
            // price appender
            Optional<com.salesmanager.shop.model.catalog.product.ProductPriceDescription>
                description =
                    priceEntity.getDescriptions().stream()
                        .filter(
                            d -> d.getLanguage() != null && d.getLanguage().equals(lang.getCode()))
                        .findFirst();
      ...
      if (source.getAttributes() != null) {
        for (com.salesmanager.shop.model.catalog.product.attribute.PersistableProductAttribute
