...
public class ReadableOrderPopulator extends AbstractDataPopulator<Order, ReadableOrder> {
  ...
  public ReadableOrder populate(
    ...
    if (source.getOrderAttributes() != null && source.getOrderAttributes().size() > 0) {
      for (OrderAttribute attr : source.getOrderAttributes()) {
        com.salesmanager.shop.model.order.OrderAttribute a =
            new com.salesmanager.shop.model.order.OrderAttribute();
    ...
    List<com.salesmanager.shop.model.order.total.OrderTotal> totals =
        new ArrayList<com.salesmanager.shop.model.order.total.OrderTotal>();
  ...
  private com.salesmanager.shop.model.order.total.OrderTotal createTotal(OrderTotal t) {
    com.salesmanager.shop.model.order.total.OrderTotal totalTotal =
        new com.salesmanager.shop.model.order.total.OrderTotal();
