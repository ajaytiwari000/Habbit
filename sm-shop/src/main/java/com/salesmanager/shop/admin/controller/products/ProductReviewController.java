...
public class ProductReviewController {
  ...
  public String displayProductReviews(
  ...
  public @ResponseBody ResponseEntity<String> pageProductReviews(
  ...
  public @ResponseBody ResponseEntity<String> deleteProductReview(
    ...
    try {
      ...
      if (review == null
          || review.getProduct().getMerchantStore().getId().intValue() != store.getId()) {
