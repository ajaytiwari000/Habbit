...
public class OrderActionsControler {
  ...
  @Inject EmailTemplatesUtils emailTemplatesUtils;

  @PreAuthorize("hasRole('ORDER')")
  @RequestMapping(value = "/admin/orders/captureOrder.html", method = RequestMethod.POST)
  public @ResponseBody ResponseEntity<String> captureOrder(
  ...
  public @ResponseBody ResponseEntity<String> refundOrder(
  ...
  public @ResponseBody ResponseEntity<String> listTransactions(
    ...
    try {
      ...
      if (transactions != null) {
        ...
        for (Transaction transaction : transactions) {
          ...
          entry.put(
              "transactionAmount", pricingService.getStringAmount(transaction.getAmount(), store));
  ...
  public @ResponseBody ResponseEntity<String> sendInvoice(
      HttpServletRequest request, HttpServletResponse response) throws Exception {
  ...
  public @ResponseBody ResponseEntity<String> updateStatus(
    ...
    try {
      ...
      emailTemplatesUtils.sendUpdateOrderStatusEmail(
          customer, dbOrder, lastHistory, store, customerLocale, request.getContextPath());
  ...
  public @ResponseBody ResponseEntity<String> sendDownloadEmail(
      HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    try {
      ...
      emailTemplatesUtils.sendOrderDownloadEmail(
          customer, dbOrder, store, customerLocale, request.getContextPath());
