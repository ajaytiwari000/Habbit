...
public class UserServicesImpl implements WebUserServices {
  ...
  public UserDetails loadUserByUsername(String userName)
    ...
    try {
      ...
      for (Permission permission : permissions) {
        GrantedAuthority auth =
            new SimpleGrantedAuthority(ROLE_PREFIX + permission.getPermissionName());
    ...
    User secUser =
        new User(userName, user.getAdminPassword(), user.isActive(), true, true, true, authorities);
    return secUser;
  }
  ...
  public void createDefaultAdmin() throws Exception {
    ...
    com.salesmanager.core.model.user.User user =
        new com.salesmanager.core.model.user.User("admin@habbit.com", password, "admin@habbit.com");
