...
public class ManufacturerController {
  ...
  public String editManufacturer(
      @RequestParam("id") long manufacturerId,
      Model model,
  ...
  private String displayManufacturer(
      Long manufacturerId, Model model, HttpServletRequest request, HttpServletResponse response)
      throws Exception {
    ...
    com.salesmanager.shop.admin.model.catalog.Manufacturer manufacturer =
        new com.salesmanager.shop.admin.model.catalog.Manufacturer();
  ...
  public String saveManufacturer(
    ...
    //		if(manufacturer.getManufacturerImage()!=null && manufacturer.getManufacturerImage().getId()
    // == null) {
    ...
    if (manufacturer.getImage() != null && !manufacturer.getImage().isEmpty()) {
      ...
      //
      //			List<ManufacturerImageDescription> imagesDescriptions = new
      // ArrayList<ManufacturerImageDescription>();
      //
      //			for(Language l : languages) {
      //
  ...
  public @ResponseBody ResponseEntity<String> pageManufacturers(
  ...
  public @ResponseBody ResponseEntity<String> deleteManufacturer(
    ...
    try {
      ...
      if (delManufacturer == null
          || delManufacturer.getMerchantStore().getId().intValue() != store.getId().intValue()) {
  ...
  public @ResponseBody ResponseEntity<String> checkCode(
      HttpServletRequest request, HttpServletResponse response, Locale locale) {
