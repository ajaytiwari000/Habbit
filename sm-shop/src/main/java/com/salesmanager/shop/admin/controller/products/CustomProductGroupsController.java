...
public class CustomProductGroupsController {
  ...
  public String displayProductGroups(
  ...
  public @ResponseBody ResponseEntity<String> pageCustomGroups(
  ...
  public String saveCustomProductGroup(
      @ModelAttribute("group") ProductRelationship group,
    ...
    for (ProductRelationship grp : groups) {
      if (grp.getCode().equalsIgnoreCase(group.getCode())) {
        ...
        FieldError fieldError =
            new FieldError("group", "code", group.getCode(), false, messages, args, null);
        result.addError(fieldError);
      }
    }
  ...
  public @ResponseBody ResponseEntity<String> removeCustomProductGroup(
      HttpServletRequest request, HttpServletResponse response) {
  ...
  public @ResponseBody ResponseEntity<String> activateProductGroup(
      HttpServletRequest request, HttpServletResponse response) {
  ...
  public String displayCustomProductGroup(
      @RequestParam("id") String groupCode,
      Model model,
      HttpServletRequest request,
      HttpServletResponse response)
      throws Exception {
  ...
  public @ResponseBody ResponseEntity<String> pageProducts(
      HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      List<ProductRelationship> relationships =
          productRelationshipService.getByGroup(store, code, language);
  ...
  @PreAuthorize("hasRole('PRODUCTS')")
  @RequestMapping(
      value = "/admin/products/group/details/removeItem.html",
      method = RequestMethod.POST)
  public @ResponseBody ResponseEntity<String> removeItem(
      HttpServletRequest request, HttpServletResponse response) {
