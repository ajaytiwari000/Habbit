...
public class UserController {
  ...
  private static final String RESET_PASSWORD_TPL = "email_template_password_reset_user.ftl";
  ...
  public @ResponseBody ResponseEntity<String> pageUsers(
  ...
  public @ResponseBody ResponseEntity<String> checkUserCode(
  ...
  public @ResponseBody ResponseEntity<String> removeUser(HttpServletRequest request, Locale locale)
      throws Exception {
  ...
  public @ResponseBody ResponseEntity<String> resetPasswordSecurityQtn(
