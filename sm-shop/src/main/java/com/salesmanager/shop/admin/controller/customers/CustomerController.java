...
public class CustomerController {
  ...
  public String displayCustomer(
      Long id, Model model, HttpServletRequest request, HttpServletResponse response)
      throws Exception {
  ...
  private void getCustomerOptions(
    ...
    if (!CollectionUtils.isEmpty(optionSet)) {
      ...
      for (CustomerOptionSet optSet : optionSet) {
        ...
        com.salesmanager.core.model.customer.attribute.CustomerOption custOption =
        ...
        if (!CollectionUtils.isEmpty(customerAttributes)) {
          for (CustomerAttribute customerAttribute : customerAttributes) {
            if (customerAttribute.getCustomerOption().getId().longValue()
              ...
              com.salesmanager.core.model.customer.attribute.CustomerOptionValue attributeValue =
  ...
  public String saveCustomer(
    ...
    //      ObjectError error =
    //          new ObjectError(
    //              "billingLastName", messages.getMessage("NotEmpty.customer.billingLastName",
    // locale));
    //      result.addError(error);
    //    }
    //
  ...
  public @ResponseBody ResponseEntity<String> pageCustomers(
  ...
  public @ResponseBody ResponseEntity<String> setCredentials(
      HttpServletRequest request, HttpServletResponse response) {
