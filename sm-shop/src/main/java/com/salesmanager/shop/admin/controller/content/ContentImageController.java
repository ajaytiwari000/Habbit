...
public class ContentImageController {
  ...
  @RequestMapping(
      value = {"/admin/content/fileBrowser.html"},
  ...
  @PreAuthorize("hasRole('CONTENT')")
  @RequestMapping(
      value = {"/admin/content/contentImages.html", "/admin/content/contentManagement.html"},
      method = RequestMethod.GET)
  ...
  public @ResponseBody ResponseEntity<String> pageImages(
        ...
        for (String name : imageNames) {
          ...
          entry.put(
              ...
              new StringBuilder()
                  ...
                  .append(imageUtils.buildStaticImageUtils(store, name))
                  .toString());
  ...
  public String displayContentImagesCreate(
