...
public class ProductAttributesController {
  ...
  public @ResponseBody ResponseEntity<String> pageAttributes(
    ...
    try {
      ...
      // List<ProductAttribute> attributes = productAttributeService.getByProductId(store, product,
      // language);
      ...
      for (ProductAttribute attr : product.getAttributes()) {
        ...
        List<ProductOptionDescription> optionsDescriptions =
            attr.getProductOption().getDescriptionsSettoList();
        ProductOptionDescription optionDescription =
            attr.getProductOption().getDescriptionsSettoList().get(0);
        ...
        List<ProductOptionValueDescription> optionValuesDescriptions =
            attr.getProductOptionValue().getDescriptionsSettoList();
        ProductOptionValueDescription optionValueDescription =
            attr.getProductOptionValue().getDescriptionsSettoList().get(0);
  ...
  @PreAuthorize("hasRole('PRODUCTS')")
  @RequestMapping(
      value = "/admin/products/attributes/editAttribute.html",
      method = RequestMethod.GET)
  public String displayAttributeEdit(
  ...
  @PreAuthorize("hasRole('PRODUCTS')")
  @RequestMapping(
      value = "/admin/products/attribute/createAttribute.html",
      method = RequestMethod.GET)
  public String displayAttributeCreate(
      @RequestParam("productId") Long productId,
      Model model,
      HttpServletRequest request,
      HttpServletResponse response)
  ...
  private String displayAttribute(
    ...
    // get OptionsValues
    List<ProductOptionValue> optionsValues =
        productOptionValueService.listByStoreNoReadOnly(store, language);
    ...
    if (id != null && id.intValue() != 0) { // edit mode
      ...
      Set<ProductOptionValueDescription> descriptions =
  ...
  public String saveAttribute(
      @Valid @ModelAttribute("attribute") ProductAttribute attribute,
    ...
    if (attribute.getId() != null && attribute.getId() > 0) { // edit entry
      ...
      if (dbEntity.getProductOption().getMerchantStore().getId().intValue()
    ...
    try {
      ...
      ObjectError error =
          new ObjectError(
              "attributePrice", messages.getMessage("NotEmpty.product.productPrice", locale));
    ...
    try {
      ...
      ObjectError error =
          new ObjectError(
              "attributeSortOrder", messages.getMessage("message.number.invalid", locale));
      result.addError(error);
    }
    ...
    try {
      ...
      ObjectError error =
          new ObjectError(
              "attributeAdditionalWeight", messages.getMessage("message.number.invalid", locale));
      result.addError(error);
    }
    ...
    if (attribute.getProductOption() == null) {
      ObjectError error =
          new ObjectError(
              "productOption.id", messages.getMessage("message.productoption.required", locale));
      result.addError(error);
      return "admin-products-attribute-details";
    }
    ...
    if (option.getProductOptionType().equals(TEXT_OPTION)) {
      ...
      if (dbEntity != null
        ...
        if (dbEntity.getProductOptionValue() != null) {
          ...
          List<ProductOptionValueDescription> descriptions =
              attribute.getProductOptionValue().getDescriptionsList();
          Set<ProductOptionValueDescription> descriptionsSet =
              new HashSet<ProductOptionValueDescription>();
          for (ProductOptionValueDescription description : descriptions) {
            description.setProductOptionValue(optVal);
            description.setName(
                description.getDescription().length() < 15
        ...
        List<ProductOptionValueDescription> descriptions =
            attribute.getProductOptionValue().getDescriptionsList();
        Set<ProductOptionValueDescription> newDescriptions =
            new HashSet<ProductOptionValueDescription>();
        ProductOptionValue newValue = new ProductOptionValue();
        for (ProductOptionValueDescription description : descriptions) {
          ProductOptionValueDescription optionValueDescription =
              new ProductOptionValueDescription();
  ...
  public @ResponseBody ResponseEntity<String> deleteProductPrice(
    ...
    try {
      ...
      if (attribute == null
          || attribute.getProduct().getMerchantStore().getId().intValue() != store.getId()) {
  ...
  @PreAuthorize("hasRole('PRODUCTS')")
  @RequestMapping(
      value = "/admin/products/attributes/getAttributeType.html",
      method = RequestMethod.POST)
  public @ResponseBody ResponseEntity<String> checkAttributeType(
      HttpServletRequest request, HttpServletResponse response, Locale locale) {
