...
public class ConfigurationController {
  ...
  public String displayAccountsConfguration(
    ...
    if (null == merchantGoogleAnalyticsConfiguration) {
      ...
      merchantGoogleAnalyticsConfiguration.setMerchantConfigurationType(
          MerchantConfigurationType.SOCIAL);
    }
  ...
  public String displayEmailSettings(
    ...
    MerchantStore store = (MerchantStore) request.getAttribute(Constants.ADMIN_STORE);
    EmailConfig emailConfig = emailsService.getEmailConfiguration(store);
    if (emailConfig == null) {
  ...
  public String saveEmailSettings(
    ...
    emailsService.saveEmailConfiguration(emailConfig, store);
