...
public class ProductPriceController {
  ...
  @Inject private ProductPriceService productPriceService;
  ...
  public @ResponseBody ResponseEntity<String> pagePrices(
    ...
    try {
      ...
      for (ProductPrice price : prices) {
        ...
        entry.put(
            "specialPrice",
            priceUtil.getAdminFormatedAmountWithCurrency(
                store, price.getProductPriceSpecialAmount()));
  ...
  public String editProductPrice(
      @RequestParam("id") long productPriceId,
  ...
  public String displayCreateProductPrice(
      @RequestParam("productId") long productId,
      @RequestParam("availabilityId") long avilabilityId,
      Model model,
      HttpServletRequest request,
      HttpServletResponse response)
      throws Exception {
  ...
  private String displayProductPrice(
    ...
    com.salesmanager.shop.admin.model.catalog.ProductPrice pprice =
        new com.salesmanager.shop.admin.model.catalog.ProductPrice();
        ...
        if (availability
            ...
            .equals(
                com.salesmanager.core.business.constants.Constants
                    .ALL_REGIONS)) { // TODO to be updated when multiple regions is implemented
          productAvailability = availability;
  ...
  public String saveProductPrice(
    ...
    if (!StringUtils.isBlank(price.getProductPriceSpecialEndDate())) {
      try {
        ...
        ObjectError error =
            new ObjectError(
                "productPriceSpecialEndDate", messages.getMessage("message.invalid.date", locale));
        result.addError(error);
      }
    }
