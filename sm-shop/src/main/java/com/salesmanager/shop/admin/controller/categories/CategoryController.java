...
public class CategoryController {
  ...
  public String displayCategoryEdit(
  ...
  public String displayCategoryCreate(
      Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
    return displayCategory(null, model, request, response);
  }

  private String displayCategory(
      Long categoryId, Model model, HttpServletRequest request, HttpServletResponse response)
      throws Exception {
    ...
    if (categoryId != null && categoryId != 0) { // edit mode
      ...
      if (category == null
          || category.getMerchantStore().getId().intValue() != store.getId().intValue()) {
    ...
    com.salesmanager.shop.admin.model.catalog.Category adminCategory =
        new com.salesmanager.shop.admin.model.catalog.Category();
  ...
  public String saveCategory(
      @Valid @ModelAttribute("category")
          com.salesmanager.shop.admin.model.catalog.Category category,
    ...
    if (category.getCategory().getId() != null
        && category.getCategory().getId() > 0) { // edit entry

      // get from DB
      Category currentCategory =
          categoryService.getById(category.getCategory().getId(), store.getId());
      ...
      if (category.getCategory().getParent().getId() == -1) { // this is a root category
        ...
        category
            ...
            .setLineage(
                new StringBuilder()
                    .append("/")
                    .append(category.getCategory().getId())
                    .append("/")
                    .toString());
  ...
  public @ResponseBody ResponseEntity<String> pageCategories(
    ...
    try {
      ...
      if (!StringUtils.isBlank(categoryName)) {
        ...
        categoryService.listByCodes(
            store, new ArrayList<String>(Arrays.asList(categoryCode)), language);
  ...
  public String displayCategoryHierarchy(
      Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
  ...
  public @ResponseBody ResponseEntity<String> moveCategory(
      HttpServletRequest request, HttpServletResponse response, Locale locale) {
    ...
    try {
      ...
      if (parentId != 1) {
        ...
        if (child == null
            || parent == null
            || child.getMerchantStore().getId() != store.getId()
  ...
  public @ResponseBody ResponseEntity<String> checkCategoryCode(
      HttpServletRequest request, HttpServletResponse response, Locale locale) {
