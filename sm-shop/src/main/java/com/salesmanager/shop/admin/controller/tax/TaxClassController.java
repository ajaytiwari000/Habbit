...
public class TaxClassController {
  ...
  @Inject private TaxClassService taxClassService = null;

  @Inject private ProductService productService = null;
  ...
  @RequestMapping(
      value = {"/admin/tax/taxclass/list.html"},
      method = RequestMethod.GET)
  public String displayTaxClasses(
  ...
  public @ResponseBody ResponseEntity<String> pageTaxClasses(
  ...
  public String saveTaxClass(
      @Valid @ModelAttribute("taxClass") TaxClass taxClass,
    ...
    if (taxClass.getCode().equals(TaxClass.DEFAULT_TAX_CLASS)) {
      ObjectError error =
          new ObjectError("code", messages.getMessage("message.taxclass.alreadyexist", locale));
  ...
  public @ResponseBody ResponseEntity<String> removeTaxClass(
