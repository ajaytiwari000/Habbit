...
public class GroupsController {
  ...
  public String save(
      @Valid @ModelAttribute("group") GroupDetails group,
    ...
    if (g != null) {
      ObjectError error =
          new ObjectError("group.groupName", messages.getMessage("message.name.exist", locale));
  ...
  public String displayGroup(Model model, HttpServletRequest request, HttpServletResponse response)
      throws Exception {
    // display menu
    setMenu(model, request);
  ...
  public @ResponseBody ResponseEntity<String> pageGroups(
    ...
    try {
      ...
      for (Group group : groups) {
        ...
        StringBuilder key =
            new StringBuilder().append("security.group.description.").append(group.getGroupName());
        try {
