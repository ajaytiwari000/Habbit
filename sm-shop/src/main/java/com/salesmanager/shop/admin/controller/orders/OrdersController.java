...
public class OrdersController {
  ...
  @Inject protected ModuleConfigurationService moduleConfigurationService;
  ...
  public @ResponseBody ResponseEntity<String> pageOrders(
    ...
    try {
      ...
      List<IntegrationModule> paymentModules =
          moduleConfigurationService.getIntegrationModules("PAYMENT");
        ...
        for (Order order : orderList.getOrders()) {
          ...
          entry.put(
              ...
              priceUtil.getAdminFormatedAmountWithCurrency(
                  store, order.getTotal())); // todo format total
