...
public class DigitalProductController {
  ...
  @RequestMapping(
      value = {"/admin/products/digitalProduct.html"},
  ...
  @PreAuthorize("hasRole('PRODUCTS')")
  @RequestMapping(
      value = "/admin/products/product/saveDigitalProduct.html",
  ...
  public String saveFile(
    ...
    if (CollectionUtils.isNotEmpty(productFiles.getFile())) {
      LOGGER.info(
          "Saving {} product files for merchant {}", productFiles.getFile().size(), store.getId());
  ...
  @PreAuthorize("hasRole('PRODUCTS')")
  @RequestMapping(
      value = "/admin/products/product/removeDigitalProduct.html",
      method = RequestMethod.POST)
  public @ResponseBody ResponseEntity<String> removeFile(
