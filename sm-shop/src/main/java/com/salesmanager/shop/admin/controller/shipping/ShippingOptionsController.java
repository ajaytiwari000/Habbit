...
public class ShippingOptionsController {
  ...
  public String displayShippingOptions(
    ...
    if (shippingConfiguration != null) {
      ...
      if (shippingConfiguration.getOrderTotalFreeShipping() != null) {
        shippingConfiguration.setOrderTotalFreeShippingText(
            priceUtil.getAdminFormatedAmount(
                store, shippingConfiguration.getOrderTotalFreeShipping()));
      }
    }
  ...
  public String saveShippingOptions(
      @ModelAttribute("configuration") ShippingConfiguration configuration,
    ...
    if (!StringUtils.isBlank(configuration.getOrderTotalFreeShippingText())) {
      try {
        ...
        ObjectError error =
            new ObjectError(
                "orderTotalFreeShippingText", messages.getMessage("message.invalid.price", locale));
    ...
    if (!StringUtils.isBlank(configuration.getHandlingFeesText())) {
      try {
        ...
        ObjectError error =
            new ObjectError(
                "handlingFeesText", messages.getMessage("message.invalid.price", locale));
        result.addError(error);
      }
    }
