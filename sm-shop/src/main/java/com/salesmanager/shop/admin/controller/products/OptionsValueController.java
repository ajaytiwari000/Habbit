...
public class OptionsValueController {
  ...
  public String displayOptionEdit(
  ...
  public String saveOption(
      @Valid @ModelAttribute("optionValue") ProductOptionValue optionValue,
  ...
  public @ResponseBody ResponseEntity<String> removeImage(
    ...
    try {
      ...
      contentService.removeFile(
          store.getCode(), FileContentType.PROPERTY, optionValue.getProductOptionValueImage());
