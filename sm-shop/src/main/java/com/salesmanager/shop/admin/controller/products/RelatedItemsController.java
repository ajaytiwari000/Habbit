...
public class RelatedItemsController {
  ...
  public String displayRelatedItems(
  ...
  public @ResponseBody ResponseEntity<String> pageRelatedItems(
    ...
    try {
      ...
      List<ProductRelationship> relationships =
          productRelationshipService.getByType(
              store, product, ProductRelationshipType.RELATED_ITEM, language);
  ...
  public @ResponseBody ResponseEntity<String> removeItem(
    ...
    try {
      ...
      List<ProductRelationship> relationships =
          productRelationshipService.getByType(
              store, baseProduct, ProductRelationshipType.RELATED_ITEM);
