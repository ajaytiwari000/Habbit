...
public class ContentPagesController {
  ...
  public String listContentPages(
  ...
  public String getContentDetails(
    ...
    if (!content.getContentType().name().equals(ContentType.PAGE.name())) {
      LOGGER.error(
          "This controller does not handle content type " + content.getContentType().name());
      return "redirect:/admin/content/pages/listContent.html";
    }
  ...
  public @ResponseBody ResponseEntity<String> removeContent(
    ...
    try {
      ...
      if (dbContent != null
          && dbContent.getMerchantStore().getId().intValue() != store.getId().intValue()) {
        resp.setStatus(AjaxResponse.RESPONSE_STATUS_FAIURE);
        String returnString = resp.toJSONString();
        return new ResponseEntity<String>(returnString, httpHeaders, HttpStatus.OK);
      }
  ...
  public @ResponseBody ResponseEntity<String> pageStaticContent(
  ...
  public @ResponseBody ResponseEntity<String> checkContentCode(
      HttpServletRequest request, HttpServletResponse response, Locale locale) {
