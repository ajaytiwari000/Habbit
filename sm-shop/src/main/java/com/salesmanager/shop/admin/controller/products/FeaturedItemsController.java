...
public class FeaturedItemsController {
  ...
  public String displayFeaturedItems(
  ...
  @PreAuthorize("hasRole('PRODUCTS')")
  @RequestMapping(
      value = "/admin/catalogue/featured/removeItem.html&removeEntity=FEATURED",
  ...
  public @ResponseBody ResponseEntity<String> removeItem(
    ...
    try {
      ...
      List<ProductRelationship> relationships =
          productRelationshipService.getByType(store, ProductRelationshipType.FEATURED_ITEM);
