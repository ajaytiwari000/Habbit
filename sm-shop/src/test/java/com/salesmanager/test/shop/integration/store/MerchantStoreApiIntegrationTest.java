...
public class MerchantStoreApiIntegrationTest extends ServicesTestSupport {
  ...
  @Inject private TestRestTemplate testRestTemplate;
  ...
  public void testCreateStoreAndDelete() throws Exception {
    ...
    PersistablesAddress address = new PersistablesAddress();
    ...
    ResponseEntity<ReadableMerchantStore> response =
        testRestTemplate.exchange(
    ...
    ResponseEntity<Void> deleteResponse =
        testRestTemplate.exchange(
            String.format("/api/v1/private/store/" + TEST_STORE_CODE),
            HttpMethod.DELETE,
            httpEntity,
            Void.class);
  ...
  public void testAddAndDeleteStoreLogo() {
    ...
    ResponseEntity<Void> createResponse =
        testRestTemplate.exchange(
            String.format(
                "/api/v1/private/store/" + MerchantStore.DEFAULT_STORE + "/marketing/logo"),
            HttpMethod.POST,
            entity,
            Void.class);
