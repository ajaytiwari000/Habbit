...
public class OptinApiIntegrationTest extends ServicesTestSupport {
  ...
  public void createOptin() throws Exception {
    ...
    final ResponseEntity<PersistableOptin> response =
        testRestTemplate.postForEntity("/api/v1/private/optin", entity, PersistableOptin.class);
  ...
  public void createCustomerOptinNewsletter() throws Exception {
    ...
    final ResponseEntity<?> resp =
        testRestTemplate.postForEntity("/api/v1/newsletter", e, PersistableCustomerOptin.class);
