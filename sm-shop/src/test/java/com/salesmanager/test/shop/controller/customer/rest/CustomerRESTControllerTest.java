...
public class CustomerRESTControllerTest {
  ...
  public void postCustomerOptionValue() throws Exception {
    ...
    List<CustomerOptionValueDescription> descriptions =
        new ArrayList<CustomerOptionValueDescription>();
    ...
    ResponseEntity response =
        restTemplate.postForEntity(
            "http://localhost:8080/sm-shop/services/private/DEFAULT/customer/optionValue",
            entity,
  ...
  public void postCustomerOption() throws Exception {
    ...
    ResponseEntity response =
        restTemplate.postForEntity(
            "http://localhost:8080/sm-shop/services/private/DEFAULT/customer/option",
            entity,
            PersistableCustomerOption.class);
  ...
  public void getCustomers() throws Exception {
    ...
    ResponseEntity<ReadableCustomer[]> response =
        restTemplate.exchange(
            "http://localhost:8080/sm-shop/services/private/DEFAULT/customer",
            HttpMethod.GET,
            httpEntity,
