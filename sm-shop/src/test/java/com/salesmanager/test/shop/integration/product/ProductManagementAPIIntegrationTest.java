...
public class ProductManagementAPIIntegrationTest extends ServicesTestSupport {
  ...
  public void createOptionValue() throws Exception {
    ...
    /**
     * { "descriptions" : [ { "name" : "Red", "description" : null, "friendlyUrl" : null, "keyWords"
     * : null, "highlights" : null, "metaDescription" : null, "title" : null, "language" : "en",
     * "id" : 0 } ], "order" : 1, "code" : "color-red", "id" : 0 }
     */
    ...
    final ResponseEntity response =
        restTemplate.postForEntity(
            "http://localhost:8080/sm-shop/services/private/DEFAULT/product/optionValue",
            entity,
  ...
  public void createOption() throws Exception {
    ...
    /**
     * { "descriptions" : [ { "name" : "Color", "description" : null, "friendlyUrl" : null,
     * "keyWords" : null, "highlights" : null, "metaDescription" : null, "title" : null, "language"
     * : "en", "id" : 0 } ], "type" : SELECT, "order" : 1, "code" : "color", "id" : 0 }
     */
    restTemplate = new RestTemplate();
    ...
    final ResponseEntity response =
        restTemplate.postForEntity(
            "http://localhost:8080/sm-shop/services/private/DEFAULT/product/option",
            entity,
  ...
  public void postProduct() throws Exception {
    ...
    final ResponseEntity response =
        restTemplate.postForEntity(
            "http://localhost:8080/api/v1/product", entity, PersistablesProduct.class);

    final PersistablesProduct prod = (PersistablesProduct) response.getBody();
  ...
  public void deleteProduct() throws Exception {
    ...
    restTemplate.exchange(
        "http://localhost:8080/sm-shop/services/rest/product/DEFAULT/en/"
            + testCategoryID
            + "/"
            + testProductID,
        HttpMethod.DELETE,
